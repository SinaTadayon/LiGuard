...
import {
  ...
  IProfileDomainManagement,
  IProfileFunctionManagement,
  IProfileUniverseManagement,
  IProfileManagement,
  IProfileMemberManagement,
  IProfilePolicyManagement,
  IProfileRealmManagement,
  IProfileRoleManagement,
  ...
  ProfileMemberManagerTest,
  ProfileMemberManagerTest__factory,
...
import {
  ...
  generateProfileMemberSignatureManually,
...
describe("Lively Guard Profile Tests", function () {
  ...
  describe("ACL Manager Proxy (UUPS Proxy Implementation) Tests", function () {
    it("Should profile proxy raised events when deployment and initialization were successful", async () => {
      ...
      const data = iface.encodeFunctionData("initialize", [ACL_MANAGER_CONTRACT_NAME, CONTRACTS_VERSION]);
      ...
      const adminChangedEvent: ProxyLocalAdminUpdatedEventObject = <ProxyLocalAdminUpdatedEventObject>(
  ...
  describe("ACL Modules Proxies Tests", function () {
    it("Should profile MemberManager proxy deploy success", async () => {
      ...
      expect(await memberManagerProxy.getLibraries()).to.be.eql([lACLAgentScope.address, lACLGenerals.address]);
    });
    ...
    it("Should profile RoleManager proxy deploy success", async () => {
      ...
      expect(await roleManagerProxy.getLibraries()).to.be.eql([lACLAgentScope.address, lACLGenerals.address]);
    });
    ...
    it("Should profile TypeManager proxy deploy success", async () => {
      ...
      expect(await typeManagerProxy.getLibraries()).to.be.eql([lACLCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile FunctionManager proxy deploy success", async () => {
      ...
      expect(await functionManagerProxy.getLibraries()).to.be.eql([lACLAgentScope.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ContextManager proxy deploy success", async () => {
      ...
      expect(await contextManagerProxy.getLibraries()).to.be.eql([lACLCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile RealmManager proxy deploy success", async () => {
      ...
      expect(await realmManagerProxy.getLibraries()).to.be.eql([lACLCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile DomainManager proxy deploy success", async () => {
      ...
      expect(await domainManagerProxy.getLibraries()).to.be.eql([lACLCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile UniverseManager proxy deploy success", async () => {
      ...
      expect(await universeManagerProxy.getLibraries()).to.be.equal([lACLCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile PolicyManager proxy deploy success", async () => {
      ...
      expect(await policyManagerProxy.getLibraries()).to.be.equal([lACLAgentScope.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfileManager proxy deploy success", async () => {
      ...
      expect(await profileManagerProxy.getLibraries()).to.be.equal([lACLCommons, lACLGenerals.address]);
    });
    ...
    it("Should profile AccessControl proxy deploy success", async () => {
      ...
      expect(await accessControlProxy.getLibrary()).to.be.equal(lACLGenerals.address);
    });
  });
  ...
  describe("ACL Profiles Modules Proxies Tests", function () {
    it("Should profile ProfileMemberManager proxy deploy success", async () => {
      ...
      expect(upgradeEvent.newImplementation, "Illegal New Implementation").to.be.hexEqual(
        profileMemberManagerSubject.address
      );
      ...
      expect(await profileMemberManagerProxy.getLibraries()).to.be.eql([lProfileCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfileRoleManager proxy deploy success", async () => {
      ...
      expect(await profileRoleManagerProxy.getLibraries()).to.be.eql([lProfileRolePolicy.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfileTypeManager proxy deploy success", async () => {
      ...
      expect(await profileTypeManagerProxy.getLibraries()).to.be.equal([lProfileCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfileFunctionManager proxy deploy success", async () => {
      ...
      expect(await profileFunctionManagerProxy.getLibraries()).to.be.equal([lProfileCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfileContextManager proxy deploy success", async () => {
      ...
      expect(await profileContextManagerProxy.getLibraries()).to.be.equal([lProfileCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfileRealmManager proxy deploy success", async () => {
      ...
      expect(await profileRealmManagerProxy.getLibraries()).to.be.equal([lProfileCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfileDomainManager proxy deploy success", async () => {
      ...
      expect(await profileDomainManagerProxy.getLibraries()).to.be.equal([lProfileCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfileUniverseManager proxy deploy success", async () => {
      ...
      expect(await profileUniverseManagerProxy.getLibraries()).to.be.equal([lProfileCommons.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfilePolicyManager proxy deploy success", async () => {
      ...
      expect(await profilePolicyManagerProxy.getLibraries()).to.be.equal([lProfileRolePolicy.address, lACLGenerals.address]);
    });
    ...
    it("Should profile ProfileAccessControl proxy deploy success", async () => {
      ...
      expect(await profileAccessControlProxy.getLibrary()).to.be.equal(lACLGenerals.address);
    });
  });
  ...
  describe("Initialize ACL Manager Tests", function () {
    ...
    it("Should register ACL contexts by systemAdmin success", async () => {
      ...
      // and
      const memberContextInfo: IContextManagement.ContextInfoStruct = await contextManagerDelegateProxy.contextGetInfo(
        memberContextId
      );
    ...
    it("Should register ACL Profile contexts by systemAdmin success", async () => {
      ...
      // and
      const profileRoleContextInfo: IContextManagement.ContextInfoStruct =
        await contextManagerDelegateProxy.contextGetInfo(profileRoleContextId);
    ...
    it("Should register MemberManger functions by systemAdmin success", async () => {
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, memberFunctionRegisterRequest)
      )
        ...
        .withArgs(
          systemAdminWallet.address,
          memberContextId,
          memberUpdateActivityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          memberContextId,
          memberUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        ...
        .withArgs(
          systemAdminWallet.address,
          memberContextId,
          memberUpdateGeneralLimitFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(await contextManagerDelegateProxy.contextHasFunction(memberContextId, memberRegisterFunctionId)).to.be
        .true;

      // and
      const functionInfo: IFunctionManagement.FunctionInfoStruct = await functionManagerDelegateProxy.functionGetInfo(
        memberRegisterFunctionId
      );
    ...
    it("Should register RoleManager functions by systemAdmin success", async () => {
      ...
      // when
      await expect(
        functionManagerDelegateProxy.connect(livelyAdmin).functionRegister(memberSignature, roleFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          roleContextId,
          roleRegisterFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          roleContextId,
          roleUpdateActivityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          roleContextId,
          roleUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        ...
        .withArgs(
          systemAdminWallet.address,
          roleContextId,
          roleUpdateMemberLimitFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
    ...
    it("Should register TypeManager functions by systemAdmin success", async () => {
      ...
      // when
      await expect(
        functionManagerDelegateProxy.connect(systemAdmin).functionRegister(memberSignature, typeFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          typeContextId,
          typeRegisterFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_TYPE_MASTER_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          typeContextId,
          typeUpdateActivityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          typeContextId,
          typeUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
    ...
    it("Should register FunctionManager functions by systemAdmin success", async () => {
      ...
      const functionRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [functionManagerProxy.address, functionIface.getSighash("functionRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        ...
        .withArgs(
          systemAdminWallet.address,
          functionContextId,
          functionUpdateActivityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          functionContextId,
          functionUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          functionContextId,
          functionUpdatePolicyFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(await contextManagerDelegateProxy.contextHasFunction(functionContextId, functionUpdateAdminFunctionId)).to
        .be.true;
    ...
    it("Should register ContextManager functions by systemAdmin success", async () => {
      ...
      const contextRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [contextManagerProxy.address, contextIface.getSighash("contextRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, contextFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          contextContextId,
          contextUpdateActivityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          contextContextId,
          contextUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        ...
        .withArgs(
          systemAdminWallet.address,
          contextContextId,
          contextUpdateFunctionLimitFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(
        await contextManagerDelegateProxy.contextHasFunction(contextContextId, contextUpdateActivityStatusFunctionId)
      ).to.be.true;
    ...
    it("Should register RealmManager functions by systemAdmin success", async () => {
      ...
      const realmRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [realmManagerProxy.address, realmIface.getSighash("realmRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, realmFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          realmContextId,
          realmRegisterFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_SCOPE_MASTER_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        ...
        .withArgs(
          systemAdminWallet.address,
          realmContextId,
          realmUpdateActivityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          realmContextId,
          realmUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          realmContextId,
          realmUpdateContextLimitFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
    ...
    it("Should register DomainManager functions by systemAdmin success", async () => {
      ...
      const domainRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [domainManagerProxy.address, domainIface.getSighash("domainRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        ...
        .withArgs(
          systemAdminWallet.address,
          domainContextId,
          domainUpdateActivityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          domainContextId,
          domainUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        ...
        .withArgs(
          systemAdminWallet.address,
          domainContextId,
          domainUpdateRealmLimitFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(await contextManagerDelegateProxy.contextHasFunction(domainContextId, domainRegisterFunctionId)).to.be
        .true;
      ...
      expect(await domainManagerDelegateProxy.domainHasFunction(LIVELY_VERSE_ACL_DOMAIN_ID, domainRegisterFunctionId))
        .to.be.true;
      expect(await domainManagerDelegateProxy.domainHasRealm(LIVELY_VERSE_ACL_DOMAIN_ID, LIVELY_VERSE_ACL_REALM_ID)).to
        .be.true;
      expect(await domainManagerDelegateProxy.domainGetRealms(LIVELY_VERSE_ACL_DOMAIN_ID)).to.be.eqls([
        LIVELY_VERSE_ACL_REALM_ID,
      ]);
    });
    ...
    it("Should register UniverseManager functions by systemAdmin success", async () => {
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, universeFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          universeContextId,
          universeUpdateActivityStatusFunctionId,
          LIVELY_VERSE_LIVELY_MASTER_ADMIN_ROLE_ID,
          LIVELY_VERSE_LIVELY_MASTER_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          universeContextId,
          universeUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_LIVELY_MASTER_ADMIN_ROLE_ID,
          LIVELY_VERSE_LIVELY_MASTER_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        ...
        .withArgs(
          systemAdminWallet.address,
          universeContextId,
          universeUpdateDomainLimitFunctionId,
          LIVELY_VERSE_LIVELY_MASTER_ADMIN_ROLE_ID,
          LIVELY_VERSE_LIVELY_MASTER_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(
        await contextManagerDelegateProxy.contextHasFunction(
          universeContextId,
          universeUpdateAlterabilityStatusFunctionId
        )
      ).to.be.true;
    ...
    it("Should register ACLManager functions by systemAdmin success", async () => {
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, aclManagerFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          aclContextId,
          aclRegisterFacetFunctionId,
          LIVELY_VERSE_LIVELY_MASTER_ADMIN_ROLE_ID,
          LIVELY_VERSE_SYSTEM_MASTER_ADMIN_ROLE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
    ...
    it("Should register AccessControl functions by systemAdmin success", async () => {
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, accessControlFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
      ...
      // then
      expect(await contextManagerDelegateProxy.contextHasFunction(accessControlContextId, upgradeToFunctionId)).to.be
        .true;
    ...
    it("Should register PolicyManager functions by systemAdmin success", async () => {
      ...
      const policyRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, policyFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          policyContextId,
          policyRegisterFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_POLICY_MASTER_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        ...
        .withArgs(
          systemAdminWallet.address,
          policyContextId,
          policyUpdateActivityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          policyContextId,
          policyUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          policyContextId,
          policyUpdateRoleLimitFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(await contextManagerDelegateProxy.contextHasFunction(policyContextId, policyRegisterFunctionId)).to.be
        .true;
    ...
    it("Should register ProfileManager functions by systemAdmin success", async () => {
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, profileFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileContextId,
          profileRegisterFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        ...
        .withArgs(
          systemAdminWallet.address,
          profileContextId,
          profileUpdateOwnerAccountFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileContextId,
          profileUpdateActivityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileContextId,
          profileUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_ACL_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(await contextManagerDelegateProxy.contextHasFunction(profileContextId, profileRegisterFunctionId)).to.be
        .true;
    ...
    it("Should register ProfileMemberManger functions by systemAdmin success", async () => {
      ...
      const profileMemberRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [profileMemberManagerProxy.address, profileMemberIface.getSighash("profileMemberRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, profileMemberFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileMemberContextId,
          profileMemberRegisterFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileMemberContextId,
          profileMemberUpdateTypeLimitFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileMemberContextId,
          profileMemberUpdateRegisterLimitFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileMemberContextId,
          profileMemberUpdateCallLimitFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileMemberContextId,
          profileMemberUpdateActivityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileMemberContextId,
          profileMemberUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileMemberContextId,
          profileMemberUpdateAdminFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(
        await contextManagerDelegateProxy.contextHasFunction(profileMemberContextId, profileMemberRegisterFunctionId)
      ).to.be.true;
    ...
    it("Should register ProfileRoleManager functions by systemAdmin success", async () => {
      ...
      const profileRoleRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [profileRoleManagerProxy.address, profileRoleIface.getSighash("profileRoleRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, profileRoleFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRoleContextId,
          profileRoleRegisterFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRoleContextId,
          profileRoleGrantMembersFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRoleContextId,
          profileRoleRevokeMembersFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRoleContextId,
          profileRoleUpdateAdminFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRoleContextId,
          profileRoleUpdateScopeFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRoleContextId,
          profileRoleUpdateActivityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRoleContextId,
          profileRoleUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRoleContextId,
          profileRoleUpdateMemberLimitFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(await contextManagerDelegateProxy.contextHasFunction(profileRoleContextId, profileRoleRegisterFunctionId))
        .to.be.true;
    ...
    it("Should register ProfileTypeManager functions by systemAdmin success", async () => {
      ...
      const profileTypeRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [profileTypeManagerProxy.address, profileTypeIface.getSighash("profileTypeRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, profileTypeFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileTypeContextId,
          profileTypeRegisterFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileTypeContextId,
          profileTypeUpdateAdminFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileTypeContextId,
          profileTypeUpdateScopeFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileTypeContextId,
          profileTypeUpdateActivityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileTypeContextId,
          profileTypeUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileTypeContextId,
          profileTypeUpdateRoleLimitFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(await contextManagerDelegateProxy.contextHasFunction(profileTypeContextId, profileTypeRegisterFunctionId))
        .to.be.true;
    ...
    it("Should register ProfileFunctionManager functions by systemAdmin success", async () => {
      ...
      const profileFunctionRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [profileFunctionManagerProxy.address, profileFunctionIface.getSighash("profileFunctionRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        ...
        .withArgs(
          systemAdminWallet.address,
          profileFunctionContextId,
          profileFunctionRegisterFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_SYSTEM_MASTER_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileFunctionContextId,
          profileFunctionUpdateAdminFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileFunctionContextId,
          profileFunctionUpdateAgentFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileFunctionContextId,
          profileFunctionUpdateActivityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileFunctionContextId,
          profileFunctionUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileFunctionContextId,
          profileFunctionUpdatePolicyCodeFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileFunctionContextId,
          profileFunctionRemoveFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
    ...
    it("Should register ProfileContextManager functions by systemAdmin success", async () => {
      ...
      const profileContextRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [profileContextManagerProxy.address, profileContextIface.getSighash("profileContextRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, profileContextFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileContextContextId,
          profileContextRegisterFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileContextContextId,
          profileContextUpdateActivityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileContextContextId,
          profileContextUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileContextContextId,
          profileContextUpdateAdminFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileContextContextId,
          profileContextUpdateFunctionLimitFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileContextContextId,
          profileContextRemoveFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_VERSE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
    ...
    it("Should register ProfileRealmManager functions by systemAdmin success", async () => {
      ...
      const profileRealmRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [profileRealmManagerProxy.address, profileRealmIface.getSighash("profileRealmRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, profileRealmFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRealmContextId,
          profileRealmRegisterFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRealmContextId,
          profileRealmUpdateAdminFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRealmContextId,
          profileRealmUpdateActivityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRealmContextId,
          profileRealmUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRealmContextId,
          profileRealmUpdateContextLimitFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileRealmContextId,
          profileRealmMoveContextFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(
        await contextManagerDelegateProxy.contextHasFunction(profileRealmContextId, profileRealmRegisterFunctionId)
      ).to.be.true;
    ...
    it("Should register ProfileDomainManager functions by systemAdmin success", async () => {
      ...
      const profileDomainRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [profileDomainManagerProxy.address, profileDomainIface.getSighash("profileDomainRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, profileDomainFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileDomainContextId,
          profileDomainRegisterFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileDomainContextId,
          profileDomainUpdateActivityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileDomainContextId,
          profileDomainUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileDomainContextId,
          profileDomainUpdateAdminFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileDomainContextId,
          profileDomainUpdateRealmLimitFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profileDomainContextId,
          profileDomainMoveRealmFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(
        await contextManagerDelegateProxy.contextHasFunction(profileDomainContextId, profileDomainRegisterFunctionId)
      ).to.be.true;
      ...
      // and
      expect(await domainManagerDelegateProxy.domainHasContext(LIVELY_VERSE_ACL_DOMAIN_ID, profileDomainContextId)).to
        .be.true;
      expect(
        await domainManagerDelegateProxy.domainHasFunction(LIVELY_VERSE_ACL_DOMAIN_ID, profileDomainRegisterFunctionId)
      ).to.be.true;
      expect(await domainManagerDelegateProxy.domainHasRealm(LIVELY_VERSE_ACL_DOMAIN_ID, LIVELY_VERSE_ACL_REALM_ID)).to
        .be.true;
      expect(await domainManagerDelegateProxy.domainGetRealms(LIVELY_VERSE_ACL_DOMAIN_ID)).to.be.eqls([
    ...
    it("Should register ProfileUniverseManager functions by systemAdmin success", async () => {
      ...
      const tx = await functionManagerDelegateProxy
        .connect(systemAdmin)
        .functionRegister(memberSignature, profileUniverseFunctionRegisterRequest);
      await tx.wait();
      ...
      expect(
        await contextManagerDelegateProxy.contextHasFunction(
          profileUniverseContextId,
          profileUniverseUpdateAlterabilityStatusFunctionId
        )
      ).to.be.true;
      ...
      expect(functionInfo.agentType).to.be.equal(AgentType.TYPE);
      expect(functionInfo.policyCode).to.be.equal(30);
      expect(functionInfo.selector).to.be.equal(
        profileUniverseIface.getSighash("profileUniverseUpdateAlterabilityStatus")
      );
      expect(functionInfo.acstat).to.be.equal(ActivityStatus.ENABLED);
      expect(functionInfo.alstat).to.be.equal(AlterabilityStatus.UPDATABLE);
    ...
    it("Should register ProfileAccessControl functions by systemAdmin success", async () => {
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, profileAccessControlFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
      ...
      // then
      expect(await contextManagerDelegateProxy.contextHasFunction(profileAccessControlContextId, upgradeToFunctionId))
        .to.be.true;
    ...
    it("Should register ProfilePolicyManager functions by systemAdmin success", async () => {
      ...
      const profilePolicyRemoveFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
          [profilePolicyManagerProxy.address, profilePolicyIface.getSighash("profilePolicyRemove")]
        )
      );
      const upgradeToFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
      ...
      await expect(
        functionManagerDelegateProxy
          .connect(systemAdmin)
          .functionRegister(memberSignature, profilePolicyFunctionRegisterRequest)
      )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profilePolicyContextId,
          profilePolicyRegisterFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_LIVELY_MASTER_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profilePolicyContextId,
          profilePolicyAddRolesFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profilePolicyContextId,
          profilePolicyRemoveRolesFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profilePolicyContextId,
          profilePolicyUpdateCodesFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profilePolicyContextId,
          profilePolicyUpdateAdminFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profilePolicyContextId,
          profilePolicyUpdateScopeFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profilePolicyContextId,
          profilePolicyUpdateActivityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profilePolicyContextId,
          profilePolicyUpdateAlterabilityStatusFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
        .withArgs(
          systemAdminWallet.address,
          profilePolicyContextId,
          profilePolicyUpdateRoleLimitFunctionId,
          LIVELY_VERSE_PROFILE_MASTER_TYPE_ID,
          LIVELY_PROFILE_ANY_TYPE_ID
        )
        .to.emit(functionManagerDelegateProxy, "FunctionRegistered")
      ...
      // then
      expect(
        await contextManagerDelegateProxy.contextHasFunction(profilePolicyContextId, profilePolicyRegisterFunctionId)
      ).to.be.true;
  ...
  describe("Profile ACL Tests", function () {
    it("Should profile register PROFILE_TEST_NAME profile with someone failed", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(user1).profileRegister(emptyMemberSignature, requests)
    ...
    it("Should profile register PROFILE_TEST_NAME profile success", async () => {
      ...
      await expect(profileManagerDelegateProxy.connect(user1).profileRegister(memberSignature, requests))
        ...
        .withArgs(
          ...
          [256, 10, 10, 10, 10, 10, 10, 10, 10, 10]
        );
      ...
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId, profileOwnerWallet.address)).to
        .be.true;
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId, profileAdminWallet.address)).to
        .be.false;
      expect(
        await profileManagerDelegateProxy.profileCheckProfileSystemAdmin(
          profileTestId,
          profileSystemAdminWallet.address
        )
      ).to.be.true;
      ...
      // and
      expect(await profileManagerDelegateProxy.profileGetProfileAccount(profileOwnerWallet.address)).to.be.eql([
        profileTestId,
      ]);
      expect(await profileManagerDelegateProxy.profileGetProfileAccount(profileAdminWallet.address)).to.be.eql([]);
      expect(await profileManagerDelegateProxy.profileGetProfileAccount(profileSystemAdminWallet.address)).to.be.eql([
        profileTestId,
      ]);
      expect(await profileManagerDelegateProxy.profileGetAdmins(profileTestId)).to.be.eql([profileOwnerId]);

      // and
      const profileInfo: IProfileManagement.ProfileInfoStruct = await profileManagerDelegateProxy.profileGetInfo(
        profileTestId
      );
    ...
    it("Should profile invariants check success", async () => {
      ...
      const profileAdminRole = await profileRoleManagerDelegateProxy.profileRoleGetInfo(
        profileTestId,
        LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID
      );
      ...
      // and
      expect(
        await profileRoleManagerDelegateProxy.profileRoleHasAccount(
          profileTestId,
          LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID,
          profileOwnerWallet.address
        )
      ...
      const profileSystemAdminRole = await profileRoleManagerDelegateProxy.profileRoleGetInfo(
        profileTestId,
        LIVELY_PROFILE_SYSTEM_MASTER_ADMIN_ROLE_ID
      );
    ...
    it("Should profile register PROFILE_TEST_NAME_2 profile success", async () => {
      ...
      await expect(profileManagerDelegateProxy.connect(livelyAdmin).profileRegister(emptyMemberSignature, requests))
        ...
        .withArgs(
          ...
          profileSystemAdminWallet2.address,
          LIVELY_VERSE_LIVELY_MASTER_TYPE_ID,
          [2, 2, 2, 2, 2, 2, 2, 2],
          [32, 3, 3, 3, 3, 32, 3, 3, 3, 3]
        );
      ...
      expect(await profileManagerDelegateProxy.profileCheckAdmin(profileTestId, livelyAdminWallet.address)).to.be.true;
      expect(await profileManagerDelegateProxy.profileCheckOwner(profileTestId2, profileOwnerWallet2.address)).to.be
        .true;
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId2, profileOwnerWallet2.address)).to
        .be.true;
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId2, profileAdminWallet2.address)).to
        .be.false;
      expect(
        await profileManagerDelegateProxy.profileCheckProfileSystemAdmin(
          profileTestId2,
      ...
      // and
      expect(await profileManagerDelegateProxy.profileGetProfileAccount(profileOwnerWallet2.address)).to.be.eql([
        profileTestId2,
      ]);
      expect(await profileManagerDelegateProxy.profileGetProfileAccount(profileAdminWallet2.address)).to.be.eql([]);
      expect(await profileManagerDelegateProxy.profileGetProfileAccount(profileSystemAdminWallet2.address)).to.be.eql([
        profileTestId2,
      ]);
    ...
    it("Should profile disable PROFILE_TEST_NAME profile alterability by someone failed", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(user1).profileUpdateAlterabilityStatus(emptyMemberSignature, requests)
      ).to.revertedWith("ACLMemberNotFound()");
    });
    ...
    it("Should profile disable PROFILE_TEST_NAME profile alterability success", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(livelyAdmin).profileUpdateAlterabilityStatus(emptyMemberSignature, requests)
      )
    ...
    it("Should profile update limits of PROFILE_TEST_NAME profile when alterability disabled failed", async () => {
      ...
      // then
      await expect(
        profileManagerDelegateProxy.connect(livelyAdmin).profileUpdateLimits(emptyMemberSignature, requests)
    ...
    it("Should profile update OwnerAccount of PROFILE_TEST_NAME profile when alterability disabled failed", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(livelyAdmin).profileUpdateOwnerAccount(emptyMemberSignature, requests)
      ).to.revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update ActivityStatus of PROFILE_TEST_NAME profile when alterability disabled failed", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(livelyAdmin).profileUpdateActivityStatus(emptyMemberSignature, requests)
      ).to.revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update Admin of PROFILE_TEST_NAME profile when alterability disabled failed", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(livelyAdmin).profileUpdateAdmin(emptyMemberSignature, requests)
      ).to.revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile disable PROFILE_TEST_NAME profile activity by someone failed", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(user2).profileUpdateActivityStatus(emptyMemberSignature, requests)
      ).to.revertedWith("ACLMemberNotFound()");
    });
    ...
    it("Should profile disable PROFILE_TEST_NAME profile activity success", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(livelyAdmin).profileUpdateActivityStatus(memberSignature, requests)
      )
    ...
    it("Should profile update limits of PROFILE_TEST_NAME profile by someone failed", async () => {
      ...
      // then
      await expect(
        profileManagerDelegateProxy.connect(systemAdmin).profileUpdateLimits(emptyMemberSignature, requests)
    ...
    it("Should profile update limits of PROFILE_TEST_NAME profile success", async () => {
      ...
      await expect(profileManagerDelegateProxy.connect(livelyAdmin).profileUpdateLimits(emptyMemberSignature, requests))
        ...
        .withArgs(
          livelyAdminWallet.address,
          profileTestId,
          [512, 20, 20, 20, 20, 20, 20, 20, 20, 20],
    ...
    it("Should profile update admin of PROFILE_TEST_NAME profile by someone failed", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(user2).profileUpdateAdmin(emptyMemberSignature, requests)
      ).to.revertedWith("ACLMemberNotFound()");
    });
    ...
    it("Should profile update profile OwnerAccount of profileTestId by someone failed", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(user1).profileUpdateOwnerAccount(emptyMemberSignature, requests)
      ).to.revertedWith("ACLMemberNotFound()");
    });
    ...
    it("Should register profileAdmin2 to PROFILE_TEST_NAME_2 success", async () => {
      ...
      await expect(
        profileMemberManagerDelegateProxy
          ...
          .profileMemberRegister(profileMemberSignature, memberRegisterRequests)
      )
      ...
      expect(
        await profileMemberManagerDelegateProxy.profileMemberCheckAccount(profileTestId2, profileAdminWallet2.address)
      ).to.be.true;
      ...
      // and
      const memberInfo: IProfileMemberManagement.ProfileMemberInfoStruct =
        await profileMemberManagerDelegateProxy.profileMemberGetInfo(profileTestId2, profileAdminId2);
    ...
    it("Should register profileAdmin to PROFILE_TEST_NAME success", async () => {
      ...
      expect(
        await profileMemberManagerDelegateProxy.profileMemberCheckAccount(profileTestId, profileAdminWallet.address)
      ).to.be.true;
      ...
      // and
      const memberInfo: IProfileMemberManagement.ProfileMemberInfoStruct =
        await profileMemberManagerDelegateProxy.profileMemberGetInfo(profileTestId, profileAdminId);
    ...
    it("Should profile update profile OwnerAccount of profileTestId success", async () => {
      ...
      // when
      await expect(
        profileManagerDelegateProxy.connect(systemAdmin).profileUpdateOwnerAccount(emptyMemberSignature, requests)
      )
      ...
      expect(await profileManagerDelegateProxy.profileCheckId(profileTestId)).to.be.true;
      expect(await profileManagerDelegateProxy.profileCheckName(PROFILE_TEST_NAME)).to.be.true;
      expect(await profileManagerDelegateProxy.profileCheckOwner(profileTestId, profileOwnerWallet.address)).to.be
        .false;
      expect(await profileManagerDelegateProxy.profileCheckOwner(profileTestId, profileOwnerWallet2.address)).to.be
        .true;
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId, profileOwnerWallet.address)).to
        .be.false;
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId, profileOwnerWallet2.address)).to
        .be.true;
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId, profileAdminWallet.address)).to
        .be.true;
      expect(
      ...
      expect(await profileManagerDelegateProxy.profileGetAdmins(profileTestId)).to.be.eql([
        profileAdminId,
        profileOwnerId2,
      ]);
    ...
    it("Should profile update profile OwnerAccount of profileTestId2 success", async () => {
      ...
      expect(await profileManagerDelegateProxy.profileCheckId(profileTestId2)).to.be.true;
      expect(await profileManagerDelegateProxy.profileCheckName(PROFILE_TEST_NAME_2)).to.be.true;
      expect(await profileManagerDelegateProxy.profileCheckOwner(profileTestId2, profileOwnerWallet.address)).to.be
        .true;
      expect(await profileManagerDelegateProxy.profileCheckOwner(profileTestId2, profileOwnerWallet2.address)).to.be
        .false;
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId2, profileOwnerWallet.address)).to
        .be.true;
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId2, profileOwnerWallet2.address)).to
        .be.false;
      expect(await profileManagerDelegateProxy.profileCheckProfileAdmin(profileTestId2, profileAdminWallet2.address)).to
      ...
      expect(await profileManagerDelegateProxy.profileGetAdmins(profileTestId2)).to.be.eql([
        profileAdminId2,
        profileOwnerId,
      ]);
  ...
  describe("Profile Post Init Tests", function () {
    ...
    it("Should profile register profileDomainTest to Universe success", async () => {
      ...
      // when
      await expect(
        profileDomainManagerDelegateProxy.connect(profileAdmin2).profileDomainRegister(profileMemberSignature, requests)
      )
      ...
      // and
      const domainInfo: IProfileDomainManagement.ProfileDomainInfoStruct =
        await profileDomainManagerDelegateProxy.profileDomainGetInfo(profileTestId, profileDomainTestId);
      ...
      expect(await profileDomainManagerDelegateProxy.profileDomainCheckId(profileTestId, profileDomainTestId)).to.be
        .true;
      expect(await profileDomainManagerDelegateProxy.profileDomainCheckName(profileTestId, PROFILE_DOMAIN_TEST_NAME)).to
        .be.true;
      expect(
        await profileDomainManagerDelegateProxy.profileDomainCheckAdmin(
          profileTestId,
          profileDomainTestId,
          profileOwnerWallet2.address
        )
      ).to.be.true;
      expect(await profileUniverseManagerDelegateProxy.profileUniverseGetDomains(profileTestId)).to.be.eqls([
        profileDomainTestId,
      ]);

      // and
      const universeInfo: IProfileUniverseManagement.ProfileUniverseInfoStruct =
        await profileUniverseManagerDelegateProxy.profileUniverseGetInfo(profileTestId);
      ...
      expect(universeInfo.domainCount).to.be.equal(1);
      ...
      expect(universeInfo.referredByAgent).to.be.equal(5);
    });

    it("Should profile hard remove profileDomainTest success", async () => {
      // given
      profileDomainTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(PROFILE_DOMAIN_TEST_NAME));
      const expiredAt = BigNumber.from(Date.now() + 10000);
      const signature = generateProfileMemberSignatureManually(
      ...
      const domainInfo: IProfileDomainManagement.ProfileDomainInfoStruct =
        await profileDomainManagerDelegateProxy.profileDomainGetInfo(profileTestId, profileDomainTestId);
      expect(domainInfo.name).to.be.empty;
      expect(domainInfo.adminId).to.be.equal(ethers.constants.HashZero);
      expect(domainInfo.adminType).to.be.equal(AgentType.NONE);
      expect(domainInfo.universeId).to.be.equal(ethers.constants.HashZero);
      expect(domainInfo.realmLimit).to.be.equal(0);
      expect(domainInfo.realmCount).to.be.equal(0);
      expect(domainInfo.referredByAgent).to.be.equal(0);
      expect(domainInfo.stype).to.be.equal(ScopeType.NONE);
      expect(domainInfo.acstat).to.be.equal(ActivityStatus.NONE);
      expect(domainInfo.alstat).to.be.equal(AlterabilityStatus.NONE);
      ...
      expect(await profileUniverseManagerDelegateProxy.profileUniverseGetDomains(profileTestId)).to.be.empty;
      ...
      expect(universeInfo.adminType).to.be.equal(AgentType.TYPE);
      expect(universeInfo.domainLimit).to.be.equal(10);
      expect(universeInfo.domainCount).to.be.equal(0);
      expect(universeInfo.acstat).to.be.equal(ActivityStatus.ENABLED);
      expect(universeInfo.alstat).to.be.equal(AlterabilityStatus.UPDATABLE);
      expect(universeInfo.stype).to.be.equal(ScopeType.UNIVERSE);
      expect(universeInfo.referredByAgent).to.be.equal(5);
    ...
    it("Should profile register again profileDomainTest to Universe success", async () => {
      // given
      profileDomainTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(PROFILE_DOMAIN_TEST_NAME));
      const requests: IProfileDomainManagement.ProfileDomainRegisterRequestStruct[] = [
        {
    ...
    // soft remove Domain
    it("Should profile register aclTypeTest to profileDomainTest scope success", async () => {
      // given
      ...
      await expect(
        profileTypeManagerDelegateProxy
          .connect(profileOwner2)
          .profileTypeRegister(emptyProfileMemberSignature, profileTypeRegisterRequests)
      )
      ...
      const typeInfo: IProfileTypeManagement.ProfileTypeInfoStruct =
        await profileTypeManagerDelegateProxy.profileTypeGetInfo(profileTestId, aclTypeTestId);
      ...
      expect(typeInfo.scopeId).to.be.equal(profileDomainTestId);
      ...
      expect(
        await profileTypeManagerDelegateProxy.profileTypeCheckAdmin(
          profileTestId,
          aclTypeTestId,
          profileAdminWallet.address
        )
    ...
    it("Should profile soft remove profileDomainTest success", async () => {
      // given
      profileDomainTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(PROFILE_DOMAIN_TEST_NAME));
      const expiredAt = BigNumber.from(Date.now() + 10000);
      const signature = generateProfileMemberSignatureManually(
    ...
    it("Should profile disable alterability of aclDomainTest when softDeleted failed", async () => {
      // given
      const requests: IProfileACLCommonsRoles.ProfileUpdateAlterabilityRequestStruct[] = [
        {
          entityId: profileDomainTestId,
          alstat: AlterabilityStatus.DISABLED,
        },
      ];
    ...
    it("Should profile enable activity of aclDomainTest success", async () => {
      ...
      await expect(
        profileDomainManagerDelegateProxy
          .connect(profileAdmin)
          .profileDomainUpdateActivityStatus(emptyProfileMemberSignature, requests)
      )
        .to.emit(profileDomainManagerDelegateProxy, "ProfileDomainActivityUpdated")
        .withArgs(profileAdminWallet.address, profileTestId, profileDomainTestId, ActivityStatus.ENABLED);
    });
    ...
    it("Should profile register profileRealmTest to profileDomainTest success", async () => {
      ...
      // when
      await expect(
        profileRealmManagerDelegateProxy.connect(profileAdmin2).profileRealmRegister(profileMemberSignature, requests)
      )
      ...
      // and
      const realmInfo: IProfileRealmManagement.ProfileRealmInfoStruct =
        await profileRealmManagerDelegateProxy.profileRealmGetInfo(profileTestId, profileRealmTestId);
      ...
      // and
      expect(await profileRealmManagerDelegateProxy.profileRealmCheckId(profileTestId, profileRealmTestId)).to.be.true;
      expect(await profileRealmManagerDelegateProxy.profileRealmCheckName(profileTestId, PROFILE_REALM_TEST_NAME)).to.be
        .true;
      expect(
        await profileRealmManagerDelegateProxy.profileRealmCheckAdmin(
          profileTestId,
          profileRealmTestId,
          profileAdminWallet.address
        )
    ...
    it("Should profile hard remove profileRealmTest success", async () => {
      // given
      profileRealmTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(PROFILE_REALM_TEST_NAME));
      const expiredAt = BigNumber.from(Date.now() + 10000);
      const signature = generateProfileMemberSignatureManually(
      ...
      const realmInfo: IProfileRealmManagement.ProfileRealmInfoStruct =
        await profileRealmManagerDelegateProxy.profileRealmGetInfo(profileTestId, profileRealmTestId);
      expect(realmInfo.name).to.be.empty;
      expect(realmInfo.domainId).to.be.equal(ethers.constants.HashZero);
      expect(realmInfo.adminId).to.be.equal(ethers.constants.HashZero);
      expect(realmInfo.adminType).to.be.equal(AgentType.NONE);
      expect(realmInfo.contextLimit).to.be.equal(0);
      expect(realmInfo.contextCount).to.be.equal(0);
      expect(realmInfo.referredByAgent).to.be.equal(0);
      expect(realmInfo.stype).to.be.equal(ScopeType.NONE);
      expect(realmInfo.acstat).to.be.equal(ActivityStatus.NONE);
      expect(realmInfo.alstat).to.be.equal(AlterabilityStatus.NONE);
    ...
    it("Should profile register again profileRealmTest to profileDomainTest success", async () => {
      // given
      profileRealmTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(PROFILE_REALM_TEST_NAME));
      const requests: IProfileRealmManagement.ProfileRealmRegisterRequestStruct[] = [
        {
    ...
    // Soft Remove Realm
    it("Should profile update scope aclTypeTest to profileRealmTest success", async () => {
      // given
    ...
    it("Should profile soft remove profileRealmTest success", async () => {
      // given
      profileRealmTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(PROFILE_REALM_TEST_NAME));
      const expiredAt = BigNumber.from(Date.now() + 10000);
      const signature = generateProfileMemberSignatureManually(
    ...
    it("Should profile disable of aclRealmTest when softDeleted failed ", async () => {
      // given
      const requests: IProfileACLCommonsRoles.ProfileUpdateAlterabilityRequestStruct[] = [
        {
          entityId: profileRealmTestId,
          alstat: AlterabilityStatus.DISABLED,
        },
      ];
    ...
    it("Should profile enable activity of aclRealmTest success", async () => {
      ...
      await expect(
        profileRealmManagerDelegateProxy
          .connect(profileAdmin)
          .profileRealmUpdateActivityStatus(emptyProfileMemberSignature, requests)
      )
        .to.emit(profileRealmManagerDelegateProxy, "ProfileRealmActivityUpdated")
        .withArgs(profileAdminWallet.address, profileTestId, profileRealmTestId, ActivityStatus.ENABLED);
    });
    ...
    it("Should profile register profileMemberContextTest by profileSystemAdmin success", async () => {
      ...
      await expect(
        profileContextManagerDelegateProxy
          .connect(livelyAdmin)
          .profileContextRegister(profileMemberSignature, contextRequests)
      )
        ...
        .withArgs(
          ...
          profileRealmTestId,
          LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID,
          profileMemberManagerTest.address,
          ethers.constants.AddressZero,
          ethers.constants.AddressZero
        );
      ...
      const profileContextInfo: IProfileContextManagement.ProfileContextInfoStruct =
        await profileContextManagerDelegateProxy.profileContextGetInfo(profileTestId, profileMemberContextTestId);
      ...
      // and
      expect(
        await profileRealmManagerDelegateProxy.profileRealmHasContext(
          profileTestId,
          profileRealmTestId,
          ethers.utils.keccak256(profileMemberManagerTest.address)
        )
      ).to.be.true;
    });
    ...
    it("Should profile hard remove profileMemberContextTest success", async () => {
      ...
      const profileContextInfo: IProfileContextManagement.ProfileContextInfoStruct =
        await profileContextManagerDelegateProxy.profileContextGetInfo(profileTestId, profileMemberContextTestId);
      expect(profileContextInfo.realmId).to.be.equal(ethers.constants.HashZero);
      expect(profileContextInfo.adminId).to.be.equal(ethers.constants.HashZero);
      expect(profileContextInfo.contractId).to.be.equal(ethers.constants.AddressZero);
      expect(profileContextInfo.functionCount).to.be.equal(0);
      expect(profileContextInfo.functionLimit).to.be.equal(0);
      expect(profileContextInfo.referredByAgent).to.be.equal(0);
      expect(profileContextInfo.adminType).to.be.equal(AgentType.NONE);
      expect(profileContextInfo.stype).to.be.equal(ScopeType.NONE);
      expect(profileContextInfo.acstat).to.be.equal(ActivityStatus.NONE);
      expect(profileContextInfo.alstat).to.be.equal(AlterabilityStatus.NONE);
    ...
    // Soft Remove profileMemberContextTest context
    it("Should profile update scope aclTypeTest to profileMemberContextTest success", async () => {
      // given
      const requests: IProfileACLCommonsRoles.ProfileUpdateScopeRequestStruct[] = [
        {
          entityId: aclTypeTestId,
      ...
      expect(typeInfo.atype).to.be.equal(AgentType.TYPE);
      expect(typeInfo.adminId).to.be.equal(LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID);
      expect(typeInfo.scopeId).to.be.equal(profileMemberContextTestId);
      expect(typeInfo.roleLimit).to.be.equal(2);
      expect(typeInfo.roleCount).to.be.equal(0);
      expect(typeInfo.adminType).to.be.equal(AgentType.ROLE);
      expect(typeInfo.acstat).to.be.equal(ActivityStatus.ENABLED);
      ...
      expect(profileContextInfo.functionCount).to.be.equal(0);
      expect(profileContextInfo.functionLimit).to.be.equal(32);
      expect(profileContextInfo.referredByAgent).to.be.equal(1);
      expect(profileContextInfo.adminType).to.be.equal(AgentType.ROLE);
      expect(profileContextInfo.stype).to.be.equal(ScopeType.CONTEXT);
      expect(profileContextInfo.acstat).to.be.equal(ActivityStatus.ENABLED);
      expect(profileContextInfo.alstat).to.be.equal(AlterabilityStatus.UPGRADABLE);
    ...
    it("Should profile soft remove profileMemberContextTest success", async () => {
      ...
      expect(profileContextInfo.adminType).to.be.equal(AgentType.ROLE);
      expect(profileContextInfo.stype).to.be.equal(ScopeType.CONTEXT);
      expect(profileContextInfo.acstat).to.be.equal(ActivityStatus.DELETED);
      expect(profileContextInfo.alstat).to.be.equal(AlterabilityStatus.UPGRADABLE);
    ...
    it("Should profile disable alterability of profileMemberContextTest when softDeleted failed", async () => {
      // given
    ...
    it("Should profile enable activity of profileMemberContextTest success", async () => {
      ...
      await expect(
        profileContextManagerDelegateProxy
          .connect(profileAdmin)
          .profileContextUpdateActivityStatus(emptyProfileMemberSignature, requests)
      )
    ...
    // Register profileRoleContextTest Context
    it("Should profile register profileRoleContextTest by profileAdmin success", async () => {
      ...
      await expect(
        profileContextManagerDelegateProxy
          .connect(profileAdmin)
          .profileContextRegister(emptyProfileMemberSignature, contextRequests)
      )
        .to.emit(profileContextManagerDelegateProxy, "ProfileContextRegistered")
        .withArgs(
          profileSystemAdminWallet.address,
          profileTestId,
          profileRoleContextTestId,
          profileRealmTestId,
          LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID,
          profileRoleManagerTestProxy.address,
          ethers.constants.AddressZero,
      ...
      // and
      const profileContextInfo: IProfileContextManagement.ProfileContextInfoStruct =
        await profileContextManagerDelegateProxy.profileContextGetInfo(profileTestId, profileRoleContextTestId);
      expect(profileContextInfo.realmId).to.be.equal(profileRealmTestId);
      expect(profileContextInfo.adminId).to.be.equal(LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID);
    ...
    it("Should profile register profileTypeContextTest by profileAdmin to profileTest success", async () => {
      ...
      // and
      const profileContextInfo: IProfileContextManagement.ProfileContextInfoStruct =
        await profileContextManagerDelegateProxy.profileContextGetInfo(profileTestId, profileTypeContextTestId);
      expect(profileContextInfo.realmId).to.be.equal(profileRealmTestId);
      expect(profileContextInfo.adminId).to.be.equal(LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID);
    ...
    // Register profileMemberRegisterTest function
    it("Should profile register profileMemberRegisterTest function by profileSystemAdmin success", async () => {
      // given
      const memberRegisterFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
      ...
      await expect(
        profileFunctionManagerDelegateProxy
          .connect(profileSystemAdmin2)
          .profileFunctionRegister(profileMemberSignature, memberFunctionRegisterRequest)
      )
      ...
      // then
      expect(
        await profileContextManagerDelegateProxy.profileContextHasFunction(
          profileTestId,
          profileMemberContextTestId,
          memberRegisterFunctionId
        )
      ...
      // and
      const functionInfo: IProfileFunctionManagement.ProfileFunctionInfoStruct =
        await profileFunctionManagerDelegateProxy.profileFunctionGetInfo(profileTestId, memberRegisterFunctionId);
      ...
      expect(
        await profileRealmManagerDelegateProxy.profileRealmHasFunction(
          profileTestId,
          profileRealmTestId,
          memberRegisterFunctionId
        )
    ...
    it("Should profile hard remove profileMemberRegisterTest function success", async () => {
      // given
      const memberRegisterFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
      ...
      const functionInfo: IProfileFunctionManagement.ProfileFunctionInfoStruct =
        await profileFunctionManagerDelegateProxy.profileFunctionGetInfo(profileTestId, memberRegisterFunctionId);
      expect(functionInfo.adminId).to.be.equal(ethers.constants.HashZero);
      expect(functionInfo.agentId).to.be.equal(ethers.constants.HashZero);
      expect(functionInfo.contextId).to.be.equal(ethers.constants.HashZero);
      expect(functionInfo.adminType).to.be.equal(AgentType.NONE);
      expect(functionInfo.agentType).to.be.equal(AgentType.NONE);
      expect(functionInfo.policyCode).to.be.equal(0);
      expect(functionInfo.selector).to.be.equal("0x00000000");
      expect(functionInfo.acstat).to.be.equal(ActivityStatus.NONE);
      expect(functionInfo.alstat).to.be.equal(AlterabilityStatus.NONE);
      expect(functionInfo.referredByAgent).to.be.equal(0);
    ...
    it("Should profile register again profileMemberRegisterTest function by profileSystemAdmin success", async () => {
      // given
      const memberRegisterFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
    ...
    // Soft Delete profileMemberRegisterTest function
    it("Should profile update scope aclTypeTest to profileMemberRegisterTest success", async () => {
      // given
      const memberRegisterFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
      ...
      expect(typeInfo.atype).to.be.equal(AgentType.TYPE);
      expect(typeInfo.adminId).to.be.equal(LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID);
      expect(typeInfo.scopeId).to.be.equal(memberRegisterFunctionId);
      expect(typeInfo.roleLimit).to.be.equal(2);
      expect(typeInfo.roleCount).to.be.equal(0);
      expect(typeInfo.adminType).to.be.equal(AgentType.ROLE);
      expect(typeInfo.acstat).to.be.equal(ActivityStatus.ENABLED);
    ...
    it("Should profile soft remove profileMemberRegisterTest function success", async () => {
      // given
      const memberRegisterFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
    ...
    it("Should profile disable alterability of memberRegisterFunctionTest when softDeleted failed", async () => {
      // given
      const memberRegisterFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
    ...
    it("Should profile enable activity of memberRegisterFunctionTest success", async () => {
      ...
      await expect(
        profileFunctionManagerDelegateProxy
          .connect(profileAdmin)
          .profileFunctionUpdateActivityStatus(emptyProfileMemberSignature, requests)
      )
    ...
    // Register profileRoleRegister function
    it("Should profile register profileRoleRegister function by profileOwner2 success", async () => {
      ...
      await expect(
        profileFunctionManagerDelegateProxy
          .connect(profileOwner2)
          .profileFunctionRegister(emptyProfileMemberSignature, roleFunctionRegisterRequest)
      )
        .to.emit(profileFunctionManagerDelegateProxy, "ProfileFunctionRegistered")
        .withArgs(
          profileSystemAdminWallet.address,
      ...
      // and
      const functionInfo: IProfileFunctionManagement.ProfileFunctionInfoStruct =
        await profileFunctionManagerDelegateProxy.profileFunctionGetInfo(profileTestId, roleRegisterFunctionId);
      expect(functionInfo.adminId).to.be.equal(LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID);
      expect(functionInfo.agentId).to.be.equal(LIVELY_PROFILE_ANY_TYPE_ID);
    ...
    // Remove aclTypeTest
    it("Should profile remove aclTypeTest success", async () => {
      // given
      const memberRegisterFunctionId = ethers.utils.keccak256(
        ethers.utils.solidityPack(
          ["address", "bytes4"],
      ...
      const typeInfo: IProfileTypeManagement.ProfileTypeInfoStruct =
        await profileTypeManagerDelegateProxy.profileTypeGetInfo(profileTestId, aclTypeTestId);
      expect(typeInfo.name).to.be.empty;
      expect(typeInfo.atype).to.be.equal(AgentType.NONE);
      expect(typeInfo.adminId).to.be.equal(ethers.constants.HashZero);
      expect(typeInfo.scopeId).to.be.equal(ethers.constants.HashZero);
      expect(typeInfo.roleLimit).to.be.equal(0);
      expect(typeInfo.roleCount).to.be.equal(0);
      expect(typeInfo.adminType).to.be.equal(AgentType.NONE);
      expect(typeInfo.acstat).to.be.equal(ActivityStatus.NONE);
      expect(typeInfo.alstat).to.be.equal(AlterabilityStatus.NONE);

      // and
      expect(await profileTypeManagerDelegateProxy.profileTypeCheckId(profileTestId, aclTypeTestId)).to.be.false;
      expect(await profileTypeManagerDelegateProxy.profileTypeCheckName(profileTestId, ACL_TYPE_TEST_NAME)).to.be.false;
      expect(
        await profileTypeManagerDelegateProxy.profileTypeCheckAdmin(
          profileTestId,
          aclTypeTestId,
    ...
    it("Should profile remove profileDomainTest failed", async () => {
      // given
      profileDomainTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(PROFILE_DOMAIN_TEST_NAME));
      const expiredAt = BigNumber.from(Date.now() + 10000);
      const signature = generateProfileMemberSignatureManually(
  ...
  describe("Profile Agent Tests", function () {
    it("Should disable activity of LIVELY_PROFILE_LIVELY_MASTER_TYPE failed", async () => {
      // given
      const requests: IProfileACLCommonsRoles.ProfileUpdateActivityRequestStruct[] = [
        {
          entityId: LIVELY_PROFILE_LIVELY_MASTER_TYPE_ID,
          acstat: ActivityStatus.DISABLED,
        },
      ];
    ...
    it("Should disabled activity of LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE failed", async () => {
      ...
      const requests: IProfileACLCommonsRoles.ProfileUpdateActivityRequestStruct[] = [
        {
          entityId: LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID,
          acstat: ActivityStatus.DISABLED,
        },
      ];
    ...
    it("Should profile register aclTypeTest success", async () => {
      ...
      expect(realmInfo.adminType).to.be.equal(AgentType.ROLE);
      expect(realmInfo.contextLimit).to.be.equal(3);
      expect(realmInfo.contextCount).to.be.equal(3);
      expect(realmInfo.referredByAgent).to.be.equal(1);
      expect(realmInfo.stype).to.be.equal(ScopeType.REALM);
      expect(realmInfo.acstat).to.be.equal(ActivityStatus.ENABLED);
      expect(realmInfo.alstat).to.be.equal(AlterabilityStatus.UPDATABLE);
    ...
    it("Should profile again register aclTypeTest success", async () => {
      // given
      aclTypeTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(ACL_TYPE_TEST_NAME));
      const profileTypeRegisterRequests: IProfileTypeManagement.ProfileTypeRegisterRequestStruct[] = [
        {
    ...
    it("Should profile disable type alterability of aclTypeTestId success", async () => {
      ...
      await expect(
        profileTypeManagerDelegateProxy
          ...
          .profileTypeUpdateAlterabilityStatus(profileMemberSignature, requests)
      )
    ...
    it("Should profile update admin of aclTypeTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileTypeManagerDelegateProxy
          .connect(profileOwner2)
          .profileTypeUpdateAdmin(emptyProfileMemberSignature, requests)
    ...
    it("Should profile update roleLimit of aclTypeTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileTypeManagerDelegateProxy
          .connect(profileOwner2)
          .profileTypeUpdateRoleLimit(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update type alterability of aclTypeTest success", async () => {
      ...
      await expect(
        profileTypeManagerDelegateProxy
          .connect(profileOwner2)
          .profileTypeUpdateAlterabilityStatus(emptyProfileMemberSignature, requests)
      )
        .to.emit(profileTypeManagerDelegateProxy, "ProfileTypeAlterabilityUpdated")
    ...
    it("Should profile register aclRoleTest in aclTypeTest with illegal scope failed", async () => {
      ...
      await expect(
        profileRoleManagerDelegateProxy
          .connect(profileAdmin)
          .profileRoleRegister(emptyProfileMemberSignature, roleRegisterRequests)
    ...
    it("Should profile aclTypeTest update admin to ProfileSystemAdmin success", async () => {
      ...
      await expect(
        profileTypeManagerDelegateProxy
          .connect(profileAdmin)
          .profileTypeUpdateAdmin(emptyProfileMemberSignature, updateAdminRequests)
      )
    ...
    it("Should profile update profileSystemAdmin registerLimit by any member failed", async () => {
      ...
      await expect(
        profileMemberManagerDelegateProxy
          .connect(profileSystemAdmin)
          .profileMemberUpdateRegisterLimit(emptyProfileMemberSignature, requests)
      ).revertedWith("ProfileAdminAccessNotPermitted()");
    });
    ...
    it("Should profile update profileSystemAdmin typeLimit with Illegal Limit failed", async () => {
      ...
      await expect(
        profileMemberManagerDelegateProxy
          .connect(profileAdmin)
          .profileMemberUpdateTypeLimit(emptyProfileMemberSignature, requests)
    ...
    it("Should profile update profileSystemAdmin registerLimit success", async () => {
      ...
      // then
      const memberInfo: IProfileMemberManagement.ProfileMemberInfoStruct =
        await profileMemberManagerDelegateProxy.profileMemberGetInfo(profileTestId, profileSystemAdminId);
      ...
      expect(memberInfo.typeCount).to.be.equal(1);
      expect(memberInfo.typeLimit).to.be.equal(10);
      expect(memberInfo.callLimit).to.be.equal(249);
    ...
    it("Should profile register aclRoleTest4 success", async () => {
      ...
      await expect(
        profileRoleManagerDelegateProxy
          .connect(profileSystemAdmin2)
          .profileRoleRegister(profileMemberSignature, roleRegisterRequests)
      )
      ...
      // and
      const roleInfo: IProfileRoleManagement.ProfileRoleInfoStruct =
        await profileRoleManagerDelegateProxy.profileRoleGetInfo(profileTestId, aclRoleTestId4);
      ...
      // and
      expect(await profileRoleManagerDelegateProxy.profileRoleCheckId(profileTestId, aclRoleTestId4)).to.be.true;
      expect(await profileRoleManagerDelegateProxy.profileRoleCheckName(profileTestId, ACL_ROLE_TEST_NAME_4)).to.be
        .true;
      expect(
        await profileRoleManagerDelegateProxy.profileRoleCheckAdmin(
          profileTestId,
          aclRoleTestId4,
          profileAdminWallet.address
        )
    ...
    it("Should profile register aclRoleTest by profileSystemAdmin success", async () => {
      ...
      // and
      const roleInfo: IProfileRoleManagement.ProfileRoleInfoStruct =
        await profileRoleManagerDelegateProxy.profileRoleGetInfo(profileTestId, aclRoleTestId);
    ...
    it("Should profile remove aclRoleTest success", async () => {
      // when
      await expect(
        profileRoleManagerDelegateProxy
          .connect(profileAdmin)
      ...
      const roleInfo: IProfileRoleManagement.ProfileRoleInfoStruct =
        await profileRoleManagerDelegateProxy.profileRoleGetInfo(profileTestId, aclRoleTestId);
      expect(roleInfo.name).to.be.empty;
      expect(roleInfo.adminId).to.be.equal(ethers.constants.HashZero);
      expect(roleInfo.scopeId).to.be.equal(ethers.constants.HashZero);
      expect(roleInfo.typeId).to.be.equal(ethers.constants.HashZero);
      expect(roleInfo.memberLimit).to.be.equal(0);
      expect(roleInfo.memberCount).to.be.equal(0);
      expect(roleInfo.adminType).to.be.equal(AgentType.NONE);
      expect(roleInfo.atype).to.be.equal(AgentType.NONE);
      expect(roleInfo.acstat).to.be.equal(ActivityStatus.NONE);
      expect(roleInfo.alstat).to.be.equal(AlterabilityStatus.NONE);

      // and
      expect(await profileRoleManagerDelegateProxy.profileRoleCheckId(profileTestId, aclRoleTestId)).to.be.false;
      expect(await profileRoleManagerDelegateProxy.profileRoleCheckName(profileTestId, ACL_ROLE_TEST_NAME)).to.be.false;
      expect(
        await profileRoleManagerDelegateProxy.profileRoleCheckAdmin(
          profileTestId,
          aclRoleTestId,
    ...
    it("Should profile again register aclRoleTest by profileSystemAdmin success", async () => {
      // given
      aclRoleTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(ACL_ROLE_TEST_NAME));
      const roleRegisterRequests: IProfileRoleManagement.ProfileRoleRegisterRequestStruct[] = [
        {
    ...
    it("Should profile register aclRoleTest2 in aclTypeTest success", async () => {
      ...
      // and
      const roleInfo: IProfileRoleManagement.ProfileRoleInfoStruct =
        await profileRoleManagerDelegateProxy.profileRoleGetInfo(profileTestId, aclRoleTestId2);
    ...
    it("Should profile update scope aclRoleTest2 in aclTypeTest success", async () => {
      ...
      await expect(
        profileRoleManagerDelegateProxy
          .connect(profileSystemAdmin)
          .profileRoleUpdateScope(emptyProfileMemberSignature, roleRegisterRequests)
      )
    ...
    it("Should profile register aclRoleTest3 in aclTypeTest success", async () => {
      ...
      // and
      const roleInfo: IProfileRoleManagement.ProfileRoleInfoStruct =
        await profileRoleManagerDelegateProxy.profileRoleGetInfo(profileTestId, aclRoleTestId3);
    ...
    it("Should profile disable alterability of aclRoleTest success", async () => {
      ...
      await expect(
        profileRoleManagerDelegateProxy
          .connect(profileAdmin)
          .profileRoleUpdateAlterabilityStatus(emptyProfileMemberSignature, requests)
      )
    ...
    it("Should profile update admin of aclRoleTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileRoleManagerDelegateProxy
          .connect(profileAdmin)
          .profileRoleUpdateAdmin(emptyProfileMemberSignature, updateAdminRequests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update memberLimit of aclRoleTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileRoleManagerDelegateProxy
          .connect(profileAdmin)
          .profileRoleUpdateMemberLimit(emptyProfileMemberSignature, memberLimitRequests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile grant member to aclRoleTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileRoleManagerDelegateProxy
          .connect(profileAdmin)
          .profileRoleGrantMembers(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile revoke member to aclRoleTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileRoleManagerDelegateProxy
          .connect(profileAdmin)
          .profileRoleRevokeMembers(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile register new member to aclRoleTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileMemberManagerDelegateProxy
          .connect(profileAdmin)
          .profileMemberRegister(emptyProfileMemberSignature, memberRegisterRequests)
    ...
    it("Should profile aclRoleTest register user1 success", async () => {
      ...
      // and
      const memberInfo: IProfileMemberManagement.ProfileMemberInfoStruct =
        await profileMemberManagerDelegateProxy.profileMemberGetInfo(profileTestId, roleMemberUserId1);
      ...
      expect(roleInfo.typeId).to.be.equal(aclTypeTestId);
      expect(roleInfo.memberLimit).to.be.equal(3);
      expect(roleInfo.memberCount).to.be.equal(1);
      expect(roleInfo.adminType).to.be.equal(AgentType.ROLE);
      expect(roleInfo.atype).to.be.equal(AgentType.ROLE);
      expect(roleInfo.acstat).to.be.equal(ActivityStatus.ENABLED);
      expect(roleInfo.alstat).to.be.equal(AlterabilityStatus.UPDATABLE);
    ...
    it("Should profile remove register user1 success", async () => {
      // given
      const roleMemberUserId1 = ethers.utils.keccak256(userWallet1.address);
      const expiredAt = BigNumber.from(Date.now() + 10000);
      const signature = generateProfileMemberSignatureManually(
      ...
      const memberInfo: IProfileMemberManagement.ProfileMemberInfoStruct =
        await profileMemberManagerDelegateProxy.profileMemberGetInfo(profileTestId, roleMemberUserId1);
      expect(memberInfo.account).to.be.equal(ethers.constants.AddressZero);
      expect(memberInfo.adminId).to.be.equal(ethers.constants.HashZero);
      expect(memberInfo.adminType).to.be.equal(AgentType.NONE);
      expect(memberInfo.atype).to.be.equal(AgentType.NONE);
      expect(memberInfo.typeCount).to.be.equal(0);
      expect(memberInfo.typeLimit).to.be.equal(0);
      expect(memberInfo.callLimit).to.be.equal(0);
      expect(memberInfo.registerLimit.memberRegisterLimit).to.be.equal(0);
      expect(memberInfo.registerLimit.roleRegisterLimit).to.be.equal(0);
      expect(memberInfo.registerLimit.typeRegisterLimit).to.be.equal(0);
      expect(memberInfo.registerLimit.functionRegisterLimit).to.be.equal(0);
      expect(memberInfo.registerLimit.contextRegisterLimit).to.be.equal(0);
      expect(memberInfo.registerLimit.realmRegisterLimit).to.be.equal(0);
      expect(memberInfo.registerLimit.domainRegisterLimit).to.be.equal(0);
      expect(memberInfo.registerLimit.policyRegisterLimit).to.be.equal(0);
      expect(memberInfo.acstat).to.be.equal(ActivityStatus.NONE);
      expect(memberInfo.alstat).to.be.equal(AlterabilityStatus.NONE);
    ...
    it("Should profile aclRoleTest again register user1 success", async () => {
      // given
      const roleMemberUserId1 = ethers.utils.keccak256(userWallet1.address);
      const memberRegisterRequests: IProfileMemberManagement.ProfileMemberRegisterRequestStruct[] = [
        {
    ...
    it("Should profile register user2 to aclRoleTest success", async () => {
      ...
      await expect(
        profileMemberManagerDelegateProxy
          .connect(profileAdmin)
          .profileMemberRegister(emptyProfileMemberSignature, requests)
      )
        .to.emit(profileMemberManagerDelegateProxy, "ProfileMemberRegistered")
        .withArgs(
          profileAdminWallet.address,
      ...
      // and
      const memberInfo: IProfileMemberManagement.ProfileMemberInfoStruct =
        await profileMemberManagerDelegateProxy.profileMemberGetInfo(profileTestId, roleMemberUserId2);
    ...
    it("Should profile update admin user2 member success", async () => {
      ...
      await expect(
        profileMemberManagerDelegateProxy
          .connect(profileSystemAdmin)
          .profileMemberUpdateAdmin(emptyProfileMemberSignature, requests)
      )
    ...
    it("Should profile update admin of aclRoleTest success", async () => {
      ...
      // then
      expect(
        await profileRoleManagerDelegateProxy.profileRoleCheckAdmin(profileTestId, aclRoleTestId, userWallet1.address)
      ).to.be.true;
      expect(
        await profileRoleManagerDelegateProxy.profileRoleCheckAdmin(profileTestId, aclRoleTestId, userWallet2.address)
      ).to.be.true;
    });
    ...
    it("Should profile aclRoleTest register another member when meet limitation failed", async () => {
      ...
      // when
      await expect(
        profileMemberManagerDelegateProxy.connect(user1).profileMemberRegister(emptyProfileMemberSignature, requests)
    ...
    it("Should profile aclRoleTest update member limit by someone failed", async () => {
      ...
      await expect(
        profileRoleManagerDelegateProxy
          .connect(user1)
          .profileRoleUpdateMemberLimit(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Limit");
    });
    ...
    it("Should profile update callLimit of user1 success", async () => {
      ...
      await expect(
        profileMemberManagerDelegateProxy
          .connect(profileAdmin)
          .profileMemberUpdateCallLimit(emptyProfileMemberSignature, requests)
      )
    ...
    it("Should profile register user3 member to aclRoleTest success", async () => {
      ...
      // and
      const memberInfo: IProfileMemberManagement.ProfileMemberInfoStruct =
        await profileMemberManagerDelegateProxy.profileMemberGetInfo(profileTestId, roleMemberUserId3);
      ...
      // and
      expect(await profileManagerDelegateProxy.profileGetProfileAccount(userWallet3.address)).to.be.eql([
        profileTestId,
      ]);
    });
    ...
    it("Should profile revoke member from aclRoleTest and delete user3 success", async () => {
      ...
      // when
      await expect(
        profileRoleManagerDelegateProxy.connect(user1).profileRoleRevokeMembers(emptyProfileMemberSignature, requests)
      )
      ...
      // then
      expect(
        await profileRoleManagerDelegateProxy.profileRoleHasAccount(profileTestId, aclTypeTestId, userWallet3.address)
      ).to.be.false;

      // and
      expect(await profileMemberManagerDelegateProxy.profileMemberCheckId(profileTestId, userId3)).to.be.false;
      expect(await profileMemberManagerDelegateProxy.profileMemberCheckAccount(profileTestId, userWallet3.address)).to
        .be.false;
    ...
    it("Should profile grant members to profileAdmin success", async () => {
      ...
      // and
      expect(
        await profileMemberManagerDelegateProxy.profileMemberHasType(
          profileTestId,
          userId1,
          LIVELY_PROFILE_LIVELY_MASTER_TYPE_ID
        )
      ...
      // and
      expect(await profileMemberManagerDelegateProxy.profileMemberGetTypes(profileTestId, userId1)).to.be.eqls([
        aclTypeTestId,
        LIVELY_PROFILE_LIVELY_MASTER_TYPE_ID,
      ]);
      expect(await profileMemberManagerDelegateProxy.profileMemberGetTypes(profileTestId, userId2)).to.be.eqls([
        aclTypeTestId,
        LIVELY_PROFILE_LIVELY_MASTER_TYPE_ID,
      ]);
      ...
      // and
      expect(
        await profileTypeManagerDelegateProxy.profileTypeHasAccount(profileTestId, aclTypeTestId, userWallet1.address)
      ).to.be.true;
      expect(
        await profileTypeManagerDelegateProxy.profileTypeHasAccount(profileTestId, aclTypeTestId, userWallet2.address)
      ).to.be.true;

      // and
      expect(await profileTypeManagerDelegateProxy.profileTypeHasRole(profileTestId, aclTypeTestId, aclRoleTestId)).to
        .be.true;
      expect(
        await profileTypeManagerDelegateProxy.profileTypeHasRole(
          profileTestId,
          LIVELY_PROFILE_LIVELY_MASTER_TYPE_ID,
          LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID
        )
      ...
      // and
      expect(
        await profileTypeManagerDelegateProxy.profileTypeGetRoles(profileTestId, LIVELY_PROFILE_LIVELY_MASTER_TYPE_ID)
      ).to.be.eqls([LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID]);
      expect(await profileTypeManagerDelegateProxy.profileTypeGetRoles(profileTestId, aclTypeTestId)).to.be.eqls([
        aclRoleTestId4,
        aclRoleTestId,
        aclRoleTestId2,
        aclRoleTestId3,
    ...
    it("Should profile update member alterability of user1 failed", async () => {
      ...
      await expect(
        profileMemberManagerDelegateProxy
          .connect(user1)
          .profileMemberUpdateAlterabilityStatus(emptyProfileMemberSignature, requests)
    ...
    it("Should profile update admin of user1 when alterability disabled failed", async () => {
      ...
      await expect(
        profileMemberManagerDelegateProxy
          .connect(profileAdmin)
          .profileMemberUpdateAdmin(emptyProfileMemberSignature, updateAdminRequests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile user1 activity disabled success", async () => {
      ...
      // and
      const memberInfo: IProfileMemberManagement.ProfileMemberInfoStruct =
        await profileMemberManagerDelegateProxy.profileMemberGetInfo(profileTestId, userId1);
      expect(memberInfo.account).to.be.equal(userWallet1.address);
      expect(memberInfo.adminId).to.be.equal(LIVELY_PROFILE_LIVELY_MASTER_TYPE_ID);
      expect(memberInfo.adminType).to.be.equal(AgentType.TYPE);
      expect(memberInfo.atype).to.be.equal(AgentType.MEMBER);
    ...
    it("Should profile user1 update admin success", async () => {
      ...
      // then
      expect(
        await profileMemberManagerDelegateProxy.profileMemberCheckAdmin(profileTestId, userId1, userWallet2.address)
      ).to.be.true;
    });
    ...
    it("Should profile remove aclTypeTest failed", async () => {
      // when
      await expect(
        profileTypeManagerDelegateProxy
          .connect(profileOwner2)
  ...
  describe("Profile Policy Test", function () {
    it("Should profile register aclPolicyTest in ACL policy success", async () => {
      ...
      // when
      await expect(
        profilePolicyManagerDelegateProxy.connect(profileAdmin2).profilePolicyRegister(profileMemberSignature, requests)
      )
      ...
      // and
      const policyInfo: IProfilePolicyManagement.ProfilePolicyInfoStruct =
        await profilePolicyManagerDelegateProxy.profilePolicyGetInfo(profileTestId, aclPolicyTestId);
      ...
      // and
      expect(await profilePolicyManagerDelegateProxy.profilePolicyCheckId(profileTestId, aclPolicyTestId)).to.be.true;
      expect(await profilePolicyManagerDelegateProxy.profilePolicyCheckName(profileTestId, ACL_POLICY_TEST_NAME)).to.be
        .true;
      expect(
        await profilePolicyManagerDelegateProxy.profilePolicyCheckAdmin(
          profileTestId,
          aclPolicyTestId,
          profileAdminWallet.address
        )
      ...
      expect(profileContextInfo.adminId).to.be.equal(LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID);
      expect(profileContextInfo.contractId).to.be.equal(profileMemberManagerTest.address);
      expect(profileContextInfo.functionCount).to.be.equal(1);
      expect(profileContextInfo.functionLimit).to.be.equal(32);
      expect(profileContextInfo.referredByAgent).to.be.equal(1);
      expect(profileContextInfo.adminType).to.be.equal(AgentType.ROLE);
      expect(profileContextInfo.stype).to.be.equal(ScopeType.CONTEXT);
    ...
    it("Should profile remove aclPolicyTest success", async () => {
      // given
      // aclPolicyTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(ACL_POLICY_TEST_NAME));
      const expiredAt = BigNumber.from(Date.now() + 10000);
      const signature = generateProfileMemberSignatureManually(
      ...
      const policyInfo: IProfilePolicyManagement.ProfilePolicyInfoStruct =
        await profilePolicyManagerDelegateProxy.profilePolicyGetInfo(profileTestId, aclPolicyTestId);
      expect(policyInfo.name).to.be.empty;
      expect(policyInfo.adminId).to.be.equal(ethers.constants.HashZero);
      expect(policyInfo.scopeId).to.be.equal(ethers.constants.HashZero);
      expect(policyInfo.roleLimit).to.be.equal(0);
      expect(policyInfo.roleCount).to.be.equal(0);
      expect(policyInfo.ptype).to.be.equal(PolicyType.UNLOCK);
      expect(policyInfo.policyCode).to.be.equal(0);
      expect(policyInfo.acstat).to.be.equal(ActivityStatus.NONE);
      expect(policyInfo.alstat).to.be.equal(AlterabilityStatus.NONE);
    ...
    it("Should profile again register aclPolicyTest in ACL policy success", async () => {
      // given
      aclPolicyTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(ACL_POLICY_TEST_NAME));
      const requests: IProfilePolicyManagement.ProfilePolicyRegisterRequestStruct[] = [
        {
    ...
    it("Should profile add aclRoleTestId4 to aclPolicyTest success", async () => {
      ...
      await expect(
        profilePolicyManagerDelegateProxy
          .connect(profileAdmin)
          .profilePolicyAddRoles(emptyProfileMemberSignature, requests)
      )
      ...
      expect(
        await profilePolicyManagerDelegateProxy.profilePolicyHasRole(profileTestId, aclPolicyTestId, aclRoleTestId4)
      ).to.be.true;

      // and
      const policyInfo: IProfilePolicyManagement.ProfilePolicyInfoStruct =
        await profilePolicyManagerDelegateProxy.profilePolicyGetInfoByRole(profileTestId, aclRoleTestId4);
      expect(policyInfo.name).to.be.equal(ACL_POLICY_TEST_NAME);
      expect(policyInfo.adminId).to.be.equal(LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID);
      expect(policyInfo.scopeId).to.be.equal(profileMemberContextTestId);
      expect(policyInfo.roleLimit).to.be.equal(2);
    ...
    it("Should profile update scope aclPolicyTest in profileTest failed", async () => {
      ...
      await expect(
        profilePolicyManagerDelegateProxy
          .connect(profileAdmin)
          .profilePolicyUpdateScope(emptyProfileMemberSignature, requests)
      ).to.revertedWith("Illegal ScopeType");
    });
    ...
    it("Should profile disable alterability of aclPolicyTest success", async () => {
      ...
      await expect(
        profilePolicyManagerDelegateProxy
          .connect(profileOwner2)
          .profilePolicyUpdateAlterabilityStatus(emptyProfileMemberSignature, requests)
      )
    ...
    it("Should profile update admin of aclPolicyTest when alterability disabled failed", async () => {
      ...
      await expect(
        profilePolicyManagerDelegateProxy
          .connect(profileAdmin)
          .profilePolicyUpdateAdmin(emptyProfileMemberSignature, updateAdminRequests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update policyCode of aclPolicyTest when alterability disabled failed", async () => {
      ...
      await expect(
        profilePolicyManagerDelegateProxy
          .connect(profileAdmin)
          .profilePolicyUpdateCodes(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update activity of aclPolicyTest when alterability disabled failed", async () => {
      ...
      await expect(
        profilePolicyManagerDelegateProxy
          .connect(profileAdmin)
          .profilePolicyUpdateActivityStatus(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update roleLimit of aclPolicyTest when alterability disabled failed", async () => {
      ...
      await expect(
        profilePolicyManagerDelegateProxy
          .connect(profileAdmin)
          .profilePolicyUpdateRoleLimit(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile add aclRoleTestId2 to aclPolicyTest success", async () => {
      ...
      // when
      await expect(
        profilePolicyManagerDelegateProxy.connect(user1).profilePolicyAddRoles(emptyProfileMemberSignature, requests)
      )
        .to.emit(profilePolicyManagerDelegateProxy, "ProfilePolicyRoleAdded")
      ...
      expect(
        await profilePolicyManagerDelegateProxy.profilePolicyHasRole(profileTestId, aclPolicyTestId, aclRoleTestId2)
      ).to.be.true;

      // and
      const policyInfo: IProfilePolicyManagement.ProfilePolicyInfoStruct =
        await profilePolicyManagerDelegateProxy.profilePolicyGetInfoByRole(profileTestId, aclRoleTestId2);
      expect(policyInfo.name).to.be.equal(ACL_POLICY_TEST_NAME);
    ...
    it("Should profile add aclRoleTestId to aclPolicyTest success", async () => {
      ...
      expect(
        await profilePolicyManagerDelegateProxy.profilePolicyHasRole(profileTestId, aclPolicyTestId, aclRoleTestId)
      ).to.be.true;
      expect(await profilePolicyManagerDelegateProxy.profilePolicyGetRoles(profileTestId, aclPolicyTestId)).to.be.eqls([
        aclRoleTestId4,
        aclRoleTestId2,
        aclRoleTestId,
      ]);
    ...
    it("Should profile remove roles aclRoleTestId2 to aclPolicyTest success", async () => {
      ...
      await expect(
        profilePolicyManagerDelegateProxy
          .connect(profileSystemAdmin)
          .profilePolicyRemoveRoles(emptyProfileMemberSignature, requests)
      )
    ...
    it("Should profile update policyCode of aclPolicyTest to UNLOCK success", async () => {
      ...
      const isPolicyAccess = await profilePolicyManagerDelegateProxy.profilePolicyCheckAccess(
        profileTestId,
        aclPolicyTestId,
        memberRegisterFunctionId
      );
      const isRoleAccess = await profilePolicyManagerDelegateProxy.profilePolicyCheckRoleAccess(
        profileTestId,
        aclRoleTestId,
        memberRegisterFunctionId
      );
      ...
      expect(
        await profilePolicyManagerDelegateProxy.profilePolicyCheckAccess(
          profileTestId,
          aclPolicyTestId,
          memberRegisterFunctionId
        )
      ...
      expect(
        await profilePolicyManagerDelegateProxy.profilePolicyCheckRoleAccess(
          profileTestId,
          aclRoleTestId,
          memberRegisterFunctionId
        )
    ...
    it("Should profile remove aclPolicyTest failed", async () => {
      // given
      // aclPolicyTestId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(ACL_POLICY_TEST_NAME));
      const expiredAt = BigNumber.from(Date.now() + 10000);
      const signature = generateProfileMemberSignatureManually(
  ...
  describe("Profile Scope Test", function () {
    ...
    it("Should profile update admin of memberRegisterFunction when alterability disabled failed", async () => {
      ...
      await expect(
        profileFunctionManagerDelegateProxy
          .connect(profileAdmin)
          .profileFunctionUpdateAdmin(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update agent of memberRegisterFunction when alterability disabled failed", async () => {
      ...
      await expect(
        profileFunctionManagerDelegateProxy
          .connect(profileAdmin)
          .profileFunctionUpdateAgent(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update policyCode of memberRegisterFunction when alterability disabled failed", async () => {
      ...
      await expect(
        profileFunctionManagerDelegateProxy
          .connect(profileAdmin)
          .profileFunctionUpdatePolicyCode(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update alterability of memberRegisterFunction success", async () => {
      ...
      await expect(
        profileFunctionManagerDelegateProxy
          .connect(profileAdmin)
          .profileFunctionUpdateAlterabilityStatus(emptyProfileMemberSignature, requests)
      )
        .to.emit(profileFunctionManagerDelegateProxy, "ProfileFunctionAlterabilityUpdated")
    ...
    it("Should profile enable activity of memberRegisterFunction success", async () => {
      ...
      // then
      expect(
        await profileFunctionManagerDelegateProxy.profileFunctionCheckSelector(
          profileTestId,
          profileMemberManagerTest.address,
          profileTestMemberIface.getSighash("profileMemberRegisterTest")
        )
      ).to.be.true;
    });
    ...
    it("Should profile update agent of memberRegisterFunction to aclTypeTest success", async () => {
      ...
      // then
      expect(
        await profileFunctionManagerDelegateProxy.profileFunctionCheckAgent(
          profileTestId,
          memberRegisterFunctionId,
          userWallet2.address
        )
    ...
    it("Should profile update user2 registerLimit success", async () => {
      ...
      // and
      const memberInfo: IProfileMemberManagement.ProfileMemberInfoStruct =
        await profileMemberManagerDelegateProxy.profileMemberGetInfo(profileTestId, userId2);
      expect(memberInfo.account).to.be.equal(userWallet2.address);
      expect(memberInfo.adminId).to.be.equal(LIVELY_PROFILE_LIVELY_MASTER_TYPE_ID);
      expect(memberInfo.adminType).to.be.equal(AgentType.TYPE);
      expect(memberInfo.atype).to.be.equal(AgentType.MEMBER);
    ...
    it("Should profile aclRoleTest3 register user3 with Illegal role scope failed", async () => {
      // when
      await expect(profileMemberManagerTest.connect(user2).profileMemberRegisterTest(profileTestId)).to.revertedWith(
        "ProfileACLRoleScopeForbidden()"
      );
    });
    ...
    it("Should profile update admin of memberRegisterFunction success", async () => {
      ...
      await expect(
        profileFunctionManagerDelegateProxy
          .connect(profileAdmin)
          .profileFunctionUpdateAdmin(emptyProfileMemberSignature, updateAdminRequests)
      )
      ...
      // then
      expect(
        await profileFunctionManagerDelegateProxy.profileFunctionCheckAdmin(
          profileTestId,
          profileMemberRegisterFunctionId,
          userWallet1.address
        )
    ...
    it("Should profile aclRoleTest register user3 member with policy LOCK failed", async () => {
      // when
      await expect(profileMemberManagerTest.connect(user1).profileMemberRegisterTest(profileTestId)).to.revertedWith(
        "ProfileACLPolicyForbidden()"
      );
    });
    ...
    it("Should profile update policyCode of memberRegisterFunction to RLOCK success", async () => {
      ...
      // then
      const functionInfo: IProfileFunctionManagement.ProfileFunctionInfoStruct =
        await profileFunctionManagerDelegateProxy.profileFunctionGetInfo(
          profileTestId,
          profileMemberRegisterFunctionId
        );
    ...
    it("Should profile update admin of profileMemberContextTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileContextManagerDelegateProxy
          .connect(profileAdmin)
          .profileContextUpdateAdmin(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update functionLimit of profileMemberContextTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileContextManagerDelegateProxy
          .connect(profileAdmin)
          .profileContextUpdateFunctionLimit(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update alterability of profileMemberContextTest success", async () => {
      ...
      await expect(
        profileContextManagerDelegateProxy
          .connect(profileAdmin)
          .profileContextUpdateAlterabilityStatus(emptyProfileMemberSignature, requests)
      )
        .to.emit(profileContextManagerDelegateProxy, "ProfileContextAlterabilityUpdated")
    ...
    it("Should profile disable activity of profileMemberContextTest success", async () => {
      ...
      const memberContextInfo: IProfileContextManagement.ProfileContextInfoStruct =
        await profileContextManagerDelegateProxy.profileContextGetInfo(profileTestId, memberContextId);
    ...
    it("Should profile enable activity of profileMemberContextTest success", async () => {
      ...
      // then
      expect(
        await profileContextManagerDelegateProxy.profileContextHasSelector(
          profileTestId,
          profileMemberManagerTest.address,
          profileTestMemberIface.getSighash("profileMemberRegisterTest")
        )
      ...
      // and
      const functionIds = await profileContextManagerDelegateProxy.profileContextGetFunctions(
        profileTestId,
        memberContextId
      );
    ...
    it("Should profile update admin of profileMemberContextTest success", async () => {
      ...
      await expect(
        profileContextManagerDelegateProxy
          .connect(profileAdmin)
          .profileContextUpdateAdmin(emptyProfileMemberSignature, updateAdminRequests)
      )
      ...
      // then
      expect(
        await profileContextManagerDelegateProxy.profileContextCheckAdmin(
          profileTestId,
          memberContextId,
          userWallet1.address
        )
    ...
    it("Should profile register aclDomainTest in Profile Universe success", async () => {
      ...
      // and
      const domainInfo: IProfileDomainManagement.ProfileDomainInfoStruct =
        await profileDomainManagerDelegateProxy.profileDomainGetInfo(profileTestId, aclDomainTestId);
      ...
      // and
      expect(await profileDomainManagerDelegateProxy.profileDomainCheckId(profileTestId, aclDomainTestId)).to.be.true;
      expect(await profileDomainManagerDelegateProxy.profileDomainCheckName(profileTestId, ACL_DOMAIN_TEST_NAME)).to.be
        .true;
      expect(
        await profileDomainManagerDelegateProxy.profileDomainCheckAdmin(
          profileTestId,
    ...
    it("Should profile disable alterability of aclDomainTest success", async () => {
      // given
      const requests: IProfileACLCommonsRoles.ProfileUpdateAlterabilityRequestStruct[] = [
        {
    ...
    it("Should profile update admin of aclDomainTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileDomainManagerDelegateProxy
          .connect(profileAdmin)
          .profileDomainUpdateAdmin(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update roleLimit of aclDomainTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileDomainManagerDelegateProxy
          .connect(profileAdmin)
          .profileDomainUpdateRealmLimit(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update admin of aclDomainTest success", async () => {
      ...
      await expect(
        profileDomainManagerDelegateProxy
          .connect(profileAdmin)
          .profileDomainUpdateAdmin(emptyProfileMemberSignature, updateAdminRequests)
      )
    ...
    it("Should profile register aclRealmTest to aclDomainTestId success", async () => {
      ...
      // when
      await expect(
        profileRealmManagerDelegateProxy.connect(livelyAdmin).profileRealmRegister(profileMemberSignature, requests)
      )
        .to.emit(profileRealmManagerDelegateProxy, "ProfileRealmRegistered")
        .withArgs(
          userWallet1.address,
      ...
      // and
      const realmInfo: IProfileRealmManagement.ProfileRealmInfoStruct =
        await profileRealmManagerDelegateProxy.profileRealmGetInfo(profileTestId, aclRealmTestId);
      ...
      // and
      expect(await profileRealmManagerDelegateProxy.profileRealmCheckId(profileTestId, aclRealmTestId)).to.be.true;
      expect(await profileRealmManagerDelegateProxy.profileRealmCheckName(profileTestId, ACL_REALM_TEST_NAME)).to.be
        .true;
      expect(
        await profileRealmManagerDelegateProxy.profileRealmCheckAdmin(
          profileTestId,
      ...
      //
      const contexts = await profileRealmManagerDelegateProxy.profileRealmGetContexts(
        profileTestId,
        profileRealmTestId
      );
    ...
    it("Should profile update admin of aclRealmTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileRealmManagerDelegateProxy
          .connect(profileAdmin)
          .profileRealmUpdateAdmin(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update contextLimit of aclRealmTest when alterability disabled failed", async () => {
      ...
      await expect(
        profileRealmManagerDelegateProxy
          .connect(profileAdmin)
          .profileRealmUpdateContextLimit(emptyProfileMemberSignature, requests)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update admin of aclRealmTest success", async () => {
      ...
      await expect(
        profileRealmManagerDelegateProxy
          .connect(profileAdmin)
          .profileRealmUpdateAdmin(emptyProfileMemberSignature, updateAdminRequests)
      )
    ...
    it("Should profile move realm from aclDomainTestId to profileDomainTestId success", async () => {
      ...
      // when
      await expect(
        profileDomainManagerDelegateProxy.connect(user1).profileDomainMoveRealm(emptyProfileMemberSignature, requests)
      )
      ...
      expect(
        await profileDomainManagerDelegateProxy.profileDomainHasRealm(
          profileTestId,
          profileDomainTestId,
          aclRealmTestId
        )
      ...
      expect(
        await profileDomainManagerDelegateProxy.profileDomainHasRealm(profileTestId, aclDomainTestId, aclRealmTestId)
      ).to.be.false;
    ...
    it("Should profile move context from ACLRealm to ACL aclRealmTestId success", async () => {
      ...
      // when
      await expect(
        profileRealmManagerDelegateProxy.connect(user1).profileRealmMoveContext(emptyProfileMemberSignature, requests)
      )
      ...
      expect(
        await profileRealmManagerDelegateProxy.profileRealmHasContext(profileTestId, aclRealmTestId, memberContextId)
      ).to.be.true;
    ...
    it("Should profile disable alterability of universe scope success", async () => {
      ...
      // when
      await expect(
        profileUniverseManagerDelegateProxy
          .connect(profileAdmin2)
          .profileUniverseUpdateAlterabilityStatus(profileMemberSignature, AlterabilityStatus.DISABLED)
      )
    ...
    it("Should profile update admin of universe scope when alterability disabled failed", async () => {
      ...
      await expect(
        profileUniverseManagerDelegateProxy
          .connect(profileAdmin)
          .profileUniverseUpdateAdmin(emptyProfileMemberSignature, aclRoleTestId)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update activity of universe scope when alterability disabled failed", async () => {
      ...
      await expect(
        profileUniverseManagerDelegateProxy
          .connect(profileAdmin)
          .profileUniverseUpdateActivityStatus(emptyProfileMemberSignature, ActivityStatus.DISABLED)
      ).revertedWith("Illegal Updatable");
    });
    ...
    it("Should profile update alterability of universe scope success", async () => {
      ...
      await expect(
        profileUniverseManagerDelegateProxy
          .connect(profileAdmin)
          .profileUniverseUpdateAlterabilityStatus(emptyProfileMemberSignature, AlterabilityStatus.UPDATABLE)
      )
        .to.emit(profileUniverseManagerDelegateProxy, "ProfileUniverseAlterabilityUpdated")
        .withArgs(
          profileAdminWallet.address,
    ...
    it("Should profile disable activity of universe scope success", async () => {
      ...
      await expect(
        profileUniverseManagerDelegateProxy
          .connect(profileAdmin2)
          .profileUniverseUpdateActivityStatus(profileMemberSignature, ActivityStatus.DISABLED)
      )
    ...
    it("Should profile call profileMemberRegisterTest when universe disable failed", async () => {
      // when and then
      await expect(profileMemberManagerTest.connect(user1).profileMemberRegisterTest(profileTestId)).revertedWith(
        "ProfileACLUniverseActivityForbidden()"
      );
    });
    ...
    it("Should profile enable activity of universe scope success", async () => {
      ...
      await expect(
        profileUniverseManagerDelegateProxy
          .connect(profileAdmin)
          .profileUniverseUpdateActivityStatus(emptyProfileMemberSignature, ActivityStatus.ENABLED)
      )
        .to.emit(profileUniverseManagerDelegateProxy, "ProfileUniverseActivityUpdated")
        .withArgs(
          profileAdminWallet.address,
    ...
    it("Should profile update admin of universe scope to aclRoleUniverseAdminTestId success", async () => {
      ...
      await expect(
        profileUniverseManagerDelegateProxy
          .connect(profileAdmin)
          .profileUniverseUpdateAdmin(emptyProfileMemberSignature, aclRoleUniverseAdminTestId)
      )
      ...
      // then
      expect(await profileUniverseManagerDelegateProxy.profileUniverseCheckAdmin(profileTestId, userWallet3.address)).to
        .be.true;
    });
    ...
    it("Should profile update domainLimit of universe scope success", async () => {
      ...
      await expect(
        profileUniverseManagerDelegateProxy
          .connect(user3)
          .profileUniverseUpdateDomainLimit(emptyProfileMemberSignature, 5)
      )
    ...
    it("Should profile update admin of profile universe scope to PROFILE_MASTER_ADMIN success", async () => {
      ...
      await expect(
        profileUniverseManagerDelegateProxy
          .connect(user3)
          .profileUniverseUpdateAdmin(emptyProfileMemberSignature, LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID)
      )
        .to.emit(profileUniverseManagerDelegateProxy, "ProfileUniverseAdminUpdated")
        .withArgs(
          userWallet3.address,
      ...
      expect(universeInfo.alstat).to.be.equal(AlterabilityStatus.UPDATABLE);
      expect(universeInfo.stype).to.be.equal(ScopeType.UNIVERSE);
      expect(universeInfo.referredByAgent).to.be.equal(9);

      // and
      expect(await profileUniverseManagerDelegateProxy.profileUniverseCheckAdmin(profileTestId, userWallet1.address)).to
        .be.true;
      expect(await profileUniverseManagerDelegateProxy.profileUniverseCheckAdmin(profileTestId, userWallet2.address)).to
        .be.false;
      expect(await profileUniverseManagerDelegateProxy.profileUniverseGetDomains(profileTestId)).to.be.eqls([
        profileDomainTestId,
        aclDomainTestId,
