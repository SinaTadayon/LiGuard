...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    let iface = new ethers.utils.Interface(accessControlManagerSubject.abi);
    const data = iface.encodeFunctionData('initialize', ["AccessControlManager", "v0.0.1", "LIVELY_GENERAL_REALM", accessControlManagerSubject.address])
