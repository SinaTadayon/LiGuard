...
/**
 * @title AccessControlTest Contract
 * @author Sina Tadayon, https://github.com/SinaTadayon
 * @dev
 *
 */
contract AccessControlTest is ACLStorageTest, BaseUUPSProxy, IACLGeneralsTest, IACLTest {
  ...
  function hasAccess(bytes32 functionId) external returns (AuthorizationStatus) {
    ...
    return _doHasAccess(functionEntity.agentId, LACLUtilsTest.accountGenerateId(msg.sender), functionEntity);
  }
