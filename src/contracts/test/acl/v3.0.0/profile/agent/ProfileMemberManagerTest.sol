 ...
 *
 */
contract ProfileMemberManagerTest is ACLStorageTest, BaseUUPSProxy, IProfileMemberManagementTest {
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
    return interfaceId == type(IProfileMemberManagementTest).interfaceId || super.supportsInterface(interfaceId);
  }
  ...
  function profileMemberRegister(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileMemberManagementTest.profileMemberRegister.selector);
    ...
    LProfileCommonsTest.profileCheckMemberForMemberRegister(
      profileEntity,
      profileMemberEntity,
  ...
  function profileMemberUpdateActivityStatus(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileMemberManagementTest.profileMemberUpdateActivityStatus.selector);
    for (uint256 i = 0; i < requests.length; i++) {
  ...
  function profileMemberUpdateAlterabilityStatus(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileMemberManagementTest.profileMemberUpdateAlterabilityStatus.selector);
    for (uint256 i = 0; i < requests.length; i++) {
  ...
  function profileMemberUpdateAdmin(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileMemberManagementTest.profileMemberUpdateAdmin.selector);
    for (uint256 i = 0; i < requests.length; i++) {
      ProfileMemberEntity storage memberEntity = _doGetEntityAndCheckAdminAccess(
        profileEntity,
        functionEntity,
  ...
  function profileMemberUpdateTypeLimit(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileMemberManagementTest.profileMemberUpdateTypeLimit.selector);
    for (uint256 i = 0; i < requests.length; i++) {
      ProfileMemberEntity storage memberEntity = _doGetEntityAndCheckAdminAccess(
        profileEntity,
        functionEntity,
  ...
  function profileMemberUpdateRegisterLimit(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileMemberManagementTest.profileMemberUpdateRegisterLimit.selector);
  ...
  function profileMemberUpdateCallLimit(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileMemberManagementTest.profileMemberUpdateCallLimit.selector);
    for (uint256 i = 0; i < requests.length; i++) {
      ProfileMemberEntity storage memberEntity = _doGetEntityAndCheckAdminAccess(
        profileEntity,
        functionEntity,
    ...
    returns (bool)
  {
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileMemberManagementTest.profileMemberRemove.selector);
  ...
  function profileMemberCheckAdmin(
    ...
    return LProfileCommonsTest.profileMemberCheckAdmin(_data, profileId, memberId, account);
  }
  ...
  function profileMemberGetInfo(bytes32 profileId, bytes32 memberId) external view returns (ProfileMemberInfo memory) {
    return LProfileCommonsTest.profileMemberGetInfo(_data, profileId, memberId);
  }
  ...
  function _doProfileMemberRegister(
    ...
    bytes32 newMemberId = LACLUtilsTest.accountGenerateId(memberRequest.account);
    ...
    // check access
    {
      IProfileACLTest.ProfileAdminAccessStatus adminAccessStatus = _doCheckAdminAccess(
        profileEntity,
        functionEntity,
        roleEntity.ba.adminId,
        senderId
      );
      if (adminAccessStatus != IProfileACLTest.ProfileAdminAccessStatus.PERMITTED)
        LACLUtilsTest.generateProfileAdminAccessError(adminAccessStatus);
    }
    ...
    if (memberRequest.adminId != bytes32(0)) {
      ...
      if (adminAccessStatus != IProfileACLTest.ProfileAdminAccessStatus.PERMITTED)
        revert IProfileACLTest.ProfileSetAdminForbidden(adminAccessStatus);
  ...
  function _doProfileRemoveMember(
    ...
    if (memberEntity.types.length() == 0) {
      ...
      LProfileCommonsTest.updateProfileAccount(_data, memberEntity, profileId, typeId, true);
