...
import "./IProfileRoleManagementTest.sol";
 ...
 *
 */
contract ProfileRoleManagerTest is ACLStorageTest, BaseUUPSProxy, IProfileRoleManagementTest {
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
    return interfaceId == type(IProfileRoleManagementTest).interfaceId || super.supportsInterface(interfaceId);
  }
  ...
  function profileRoleRegister(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileRoleManagementTest.profileRoleRegister.selector);
    LProfileRolePolicyTest.profileCheckMemberForRoleRegister(profileEntity, uint16(requests.length), senderId);
  ...
  function profileRoleUpdateAdmin(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileRoleManagementTest.profileRoleUpdateAdmin.selector);
    for (uint256 i = 0; i < requests.length; i++) {
  ...
  function profileRoleUpdateScope(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileRoleManagementTest.profileRoleUpdateScope.selector);
    for (uint256 i = 0; i < requests.length; i++) {
      LProfileRolePolicyTest.profileRoleUpdateScope(requests[i], profileEntity, functionEntity, profileId, senderId);
  ...
  function profileRoleUpdateActivityStatus(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileRoleManagementTest.profileRoleUpdateActivityStatus.selector);
    for (uint256 i = 0; i < requests.length; i++) {
      require(requests[i].entityId != LProfileRolePolicyTest.LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID, "Illegal Role");
  ...
  function profileRoleUpdateAlterabilityStatus(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileRoleManagementTest.profileRoleUpdateAlterabilityStatus.selector);
    for (uint256 i = 0; i < requests.length; i++) {
      require(requests[i].entityId != LProfileRolePolicyTest.LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID, "Illegal Role");
  ...
  function profileRoleUpdateMemberLimit(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileRoleManagementTest.profileRoleUpdateMemberLimit.selector);
    for (uint256 i = 0; i < requests.length; i++) {
      RoleEntity storage roleEntity = _doGetEntityAndCheckAdminAccess(
        profileEntity,
        functionEntity,
  ...
  function profileRoleGrantMembers(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileRoleManagementTest.profileRoleGrantMembers.selector);
    for (uint256 i = 0; i < requests.length; i++) {
  ...
  function profileRoleRevokeMembers(
    ...
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileRoleManagementTest.profileRoleRevokeMembers.selector);
    for (uint256 i = 0; i < requests.length; i++) {
    ...
    returns (bool)
  {
    (
      ...
      bytes32 senderId,
      address sender
    ) = _accessPermission(memberSign, IProfileRoleManagementTest.profileRoleRemove.selector);
  ...
  function profileRoleCheckAdmin(
    ...
    return LProfileRolePolicyTest.profileRoleCheckAdmin(_data, profileId, roleId, account);
  }
  ...
  function profileRoleHasAccount(
    ...
    return LProfileRolePolicyTest.profileRoleHasAccount(_data, profileId, roleId, account);
  }

  function profileRoleGetInfo(bytes32 profileId, bytes32 roleId) external view returns (ProfileRoleInfo memory) {
    return LProfileRolePolicyTest.profileRoleGetInfo(_data, profileId, roleId);
  }
  ...
  function _getRoleAdmin(
    ...
    return
      LProfileRolePolicyTest.profileGetRoleAdmin(
        profileEntity,
        requestScopeType,
        requestScopeAdmin,
        scopeId,
  ...
  function _doGetEntityAndCheckAdminAccess(
    ...
    return LProfileRolePolicyTest.profileGetRoleEntityAndCheckAdminAccess(profileEntity, functionEntity, roleId, senderId);
  }
  ...
  function _updateProfileAccount(
    ...
    return LProfileRolePolicyTest.updateProfileAccount(_data, profileMemberEntity, profileId, typeId, isRevoke);
  }
  ...
  function _doProfileRoleRevokeMembers(
    ...
    for (uint256 j = 0; j < request.members.length; j++) {
      ...
      if (request.roleId == LProfileRolePolicyTest.LIVELY_PROFILE_LIVELY_MASTER_ADMIN_ROLE_ID) {
        require(request.members[j] != LACLUtilsTest.accountGenerateId(profileEntity.owner), "Illegal Owner Revoke");
      }
  ...
  function _doRoleRegister(
    ...
    (bytes32 newRoleId, bytes32 adminId) = LProfileRolePolicyTest.profileRoleRegister(
      request,
      profileEntity,
      functionEntity,
      profileId,
