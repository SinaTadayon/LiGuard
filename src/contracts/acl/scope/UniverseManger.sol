...
contract UniverseManager is ACLStorage, BaseUUPSProxy, IUniverseManagement {
  ...
  {
    (bytes32 functionId, bytes32 senderId, address sender) = _accessPermissionActivity(
      memberSign,
  ...
  function _accessPermissionActivity(MemberSignature calldata memberSign, bytes4 selector)
    internal
    returns (
      bytes32,
      bytes32,
