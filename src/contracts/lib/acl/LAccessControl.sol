...
//     data.selectors[IProxy.setActivityStatus.selector] = address(this);
//     data.selectors[IProxy.setAlterabilityStatus.selector] = address(this);
...
//     data.selectors[IProxy.activityStatus.selector] = address(this);
//     data.selectors[IProxy.alterabilityStatus.selector] = address(this);
