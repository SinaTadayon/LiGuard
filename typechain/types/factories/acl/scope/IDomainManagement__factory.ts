...
import type {
  IDomainManagement,
  IDomainManagementInterface,
} from "../../../acl/scope/IDomainManagement";
...
export class IDomainManagement__factory {
  static readonly abi = _abi;
  static createInterface(): IDomainManagementInterface {
    return new utils.Interface(_abi) as IDomainManagementInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDomainManagement {
    return new Contract(address, _abi, signerOrProvider) as IDomainManagement;
  }
}
