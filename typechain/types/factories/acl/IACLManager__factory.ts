    ...
    inputs: [
      {
        ...
        internalType: "struct IACLCommons.FacetRegisterRequest[]",
        name: "requests",
        type: "tuple[]",
      },
    ],
    ...
    inputs: [
      {
        components: [
          ...
          },
          {
            ...
            internalType: "struct IACLCommons.FacetSelectorUpgradeRequest[]",
            name: "functions",
            type: "tuple[]",
          },
        ],
        internalType: "struct IACLCommons.FacetUpgradeRequest[]",
        name: "requests",
        type: "tuple[]",
      },
    ],
