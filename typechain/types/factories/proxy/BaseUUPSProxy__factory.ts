...
import type {
  BaseUUPSProxy,
  BaseUUPSProxyInterface,
} from "../../proxy/BaseUUPSProxy";
...
export class BaseUUPSProxy__factory {
  static readonly abi = _abi;
  static createInterface(): BaseUUPSProxyInterface {
    return new utils.Interface(_abi) as BaseUUPSProxyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BaseUUPSProxy {
    return new Contract(address, _abi, signerOrProvider) as BaseUUPSProxy;
  }
}
