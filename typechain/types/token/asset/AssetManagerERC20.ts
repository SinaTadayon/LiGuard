...
export interface AssetManagerERC20Interface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "initVersion()"
      | "initialize"
      | "initialize((string,string,string,address,address,bytes,bytes))"
      | "isAssetExists"
  ...
  encodeFunctionData(
    functionFragment: "initialize((string,string,string,address,address,bytes,bytes))",
    values: [AssetManagerERC20.InitRequestStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "registerAssetRoles",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "registerAssetRoles()",
