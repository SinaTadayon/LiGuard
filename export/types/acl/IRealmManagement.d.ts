...
export interface IRealmManagementInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getRealmContexts" | "getRealmContexts(bytes32)" | "getRealmInfo" | "getRealmInfo(bytes32)" | "hasRealmContext" | "hasRealmContext(bytes32,bytes32)" | "registerRealm" | "registerRealm(string,bool,bool)" | "setRealmStatus" | "setRealmStatus(bytes32,bool)" | "setRealmUpgradeStatus" | "setRealmUpgradeStatus(bytes32,bool)"): FunctionFragment;
