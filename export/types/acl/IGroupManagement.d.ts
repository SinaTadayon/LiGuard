...
export interface IGroupManagementInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getGroupInfo" | "getGroupInfo(bytes32)" | "getGroupRoles" | "getGroupRoles(bytes32)" | "hasGroupRole" | "hasGroupRole(bytes32,bytes32)" | "registerGroup" | "registerGroup(string,bool)" | "setGroupStatus" | "setGroupStatus(bytes32,bool)"): FunctionFragment;
