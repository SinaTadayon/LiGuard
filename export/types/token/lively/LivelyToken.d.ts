...
export declare namespace IERC20Extra {
  ...
  type BatchTransferFromRequestStructOutput = [string, string, BigNumber] & {
    source: string;
    recipient: string;
    amount: BigNumber;
  };
...
export declare namespace LivelyToken {
  ...
  type InitRequestStructOutput = [string, string, string, string, BigNumber, BigNumber, string, string, string] & {
    domainName: string;
...
export declare type ApprovalDecresedEvent = TypedEvent<[string, string, BigNumber], ApprovalDecresedEventObject>;
...
export declare type ApprovalIncrementedEvent = TypedEvent<[string, string, BigNumber], ApprovalIncrementedEventObject>;
...
export declare type BatchTransferEvent = TypedEvent<[string, BigNumber], BatchTransferEventObject>;
...
export declare type BatchTransferFromEvent = TypedEvent<[string, BigNumber], BatchTransferFromEventObject>;
...
export declare type BurnEvent = TypedEvent<[string, string, BigNumber, BigNumber], BurnEventObject>;
...
export declare type MintEvent = TypedEvent<[string, string, BigNumber, BigNumber], MintEventObject>;
...
export declare type TaxRateUpdatedEvent = TypedEvent<[string, BigNumber], TaxRateUpdatedEventObject>;
...
export declare type TaxWhitelistUpdatedEvent = TypedEvent<[string, string, boolean], TaxWhitelistUpdatedEventObject>;
...
export declare type TransferFromEvent = TypedEvent<[string, string, string, BigNumber], TransferFromEventObject>;
