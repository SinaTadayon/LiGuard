...
export interface UUPSUpgradeableTestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "proxiableUUID" | "proxiableUUID()" | "supportsInterface" | "supportsInterface(bytes4)" | "upgradeTo" | "upgradeTo(address)" | "upgradeToAndCall" | "upgradeToAndCall(address,bytes)"): FunctionFragment;
...
export interface UUPSUpgradeableTest extends BaseContract {
    ...
    functions: {
        ...
        "upgradeTo(address)"(newImplementation: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
