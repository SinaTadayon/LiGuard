...
export declare type UpgradeToAnonymousEvent = TypedEvent<[string, string], UpgradeToAnonymousEventObject>;
...
export declare type UpgradeToTesterEvent = TypedEvent<[string, string], UpgradeToTesterEventObject>;
