...
class ACLManager__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            ...
            super(_abi, ACLManager__factory.linkBytecode(linkLibraryAddresses), signer);
        }
    }
...
//# sourceMappingURL=ACLManager__factory.js.map