...
export interface LAccessControlInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "LIB_NAME" | "LIB_NAME()" | "LIB_VERSION" | "LIB_VERSION()" | "LIVELY_ADMIN_ROLE" | "LIVELY_ADMIN_ROLE()" | "LIVELY_ANONYMOUS_ROLE" | "LIVELY_ANONYMOUS_ROLE()" | "LIVELY_ASSET_ADMIN_ROLE" | "LIVELY_ASSET_ADMIN_ROLE()" | "LIVELY_ASSET_GROUP" | "LIVELY_ASSET_GROUP()" | "LIVELY_ASSET_MANAGER_ROLE" | "LIVELY_ASSET_MANAGER_ROLE()" | "LIVELY_ASSET_REALM" | "LIVELY_ASSET_REALM()" | "LIVELY_COMMUNITY_DAO_EXECUTOR_ROLE" | "LIVELY_COMMUNITY_DAO_EXECUTOR_ROLE()" | "LIVELY_COMMUNITY_DAO_ROLE" | "LIVELY_COMMUNITY_DAO_ROLE()" | "LIVELY_DAO_GROUP" | "LIVELY_DAO_GROUP()" | "LIVELY_GENERAL_GROUP" | "LIVELY_GENERAL_GROUP()" | "LIVELY_GENERAL_REALM" | "LIVELY_GENERAL_REALM()" | "LIVELY_SYSTEM_ADMIN_ROLE" | "LIVELY_SYSTEM_ADMIN_ROLE()" | "createRequestContext" | "createRequestContext()"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "LIVELY_ASSET_MANAGER_ROLE()", values?: undefined): string;
    encodeFunctionData(functionFragment: "LIVELY_ASSET_REALM", values?: undefined): string;
    encodeFunctionData(functionFragment: "LIVELY_ASSET_REALM()", values?: undefined): string;
    encodeFunctionData(functionFragment: "LIVELY_COMMUNITY_DAO_EXECUTOR_ROLE", values?: undefined): string;
    encodeFunctionData(functionFragment: "LIVELY_COMMUNITY_DAO_EXECUTOR_ROLE()", values?: undefined): string;
    encodeFunctionData(functionFragment: "LIVELY_COMMUNITY_DAO_ROLE", values?: undefined): string;
    encodeFunctionData(functionFragment: "LIVELY_COMMUNITY_DAO_ROLE()", values?: undefined): string;
    encodeFunctionData(functionFragment: "LIVELY_DAO_GROUP", values?: undefined): string;
    encodeFunctionData(functionFragment: "LIVELY_DAO_GROUP()", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "LIVELY_ASSET_MANAGER_ROLE()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "LIVELY_ASSET_REALM", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "LIVELY_ASSET_REALM()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "LIVELY_COMMUNITY_DAO_EXECUTOR_ROLE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "LIVELY_COMMUNITY_DAO_EXECUTOR_ROLE()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "LIVELY_COMMUNITY_DAO_ROLE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "LIVELY_COMMUNITY_DAO_ROLE()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "LIVELY_DAO_GROUP", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "LIVELY_DAO_GROUP()", data: BytesLike): Result;
...
export interface LAccessControl extends BaseContract {
    ...
    populateTransaction: {
        ...
        "LIVELY_ASSET_MANAGER_ROLE()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        LIVELY_ASSET_REALM(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "LIVELY_ASSET_REALM()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        LIVELY_COMMUNITY_DAO_EXECUTOR_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "LIVELY_COMMUNITY_DAO_EXECUTOR_ROLE()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        LIVELY_COMMUNITY_DAO_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "LIVELY_COMMUNITY_DAO_ROLE()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
