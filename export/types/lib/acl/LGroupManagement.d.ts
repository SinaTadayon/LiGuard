...
export interface LGroupManagementInterface extends utils.Interface {
    functions: {
...
export interface LGroupManagement extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LGroupManagementInterface;
