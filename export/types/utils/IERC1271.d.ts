...
export interface IERC1271 extends BaseContract {
    ...
    functions: {
        ...
        "isValidSignature(bytes32,bytes)"(hash: PromiseOrValue<BytesLike>, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string] & {
            magicValue: string;
        }>;
    };
    isValidSignature(hash: PromiseOrValue<BytesLike>, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        "isValidSignature(bytes32,bytes)"(hash: PromiseOrValue<BytesLike>, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        "isValidSignature(bytes32,bytes)"(hash: PromiseOrValue<BytesLike>, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
