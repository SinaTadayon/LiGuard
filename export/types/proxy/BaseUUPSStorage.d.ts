...
export interface BaseUUPSStorageInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface BaseUUPSStorage extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BaseUUPSStorageInterface;
